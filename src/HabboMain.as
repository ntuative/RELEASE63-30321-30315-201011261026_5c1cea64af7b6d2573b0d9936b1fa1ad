package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_805:Number = 0.71;
      ...
      private var var_1169:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1169 = HabboTracking.getInstance();
         ...
         {
            _loc1_.addEventListener(AssetLoaderEvent.const_31,this.configLoadedHandler);
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_31,this.configLoadedHandler);
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1169 && !this.var_1169.disposed)
                  {
                     this.var_1169.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_805 + this.var_22.getNumberOfFilesLoaded() / _loc11_ * const_805;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
