package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1541:int = 50;
      ...
      private var var_493:Point;
      
      private var var_244:BitmapDataCache;
      
      private var var_607:RoomObjectCache;
      
      private var var_492:Array;
      
      private var var_606:Array;
      
      private var var_1388:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2538:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_245 = new Sprite();
         this.var_245.mouseEnabled = false;
         this.var_54 = new Sprite();
         this.var_54.name = "canvas";
         this.var_54.mouseEnabled = false;
         this.var_245.addChild(this.var_54);
         ...
         this.var_244 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_607 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_493.x -= param1 - this.var_608;
         this.var_608 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_493.y -= param1 - this.var_604;
         this.var_604 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_812 = true;
            if(this.var_124 != null && !this.var_245.contains(this.var_124))
            {
               this.var_245.addChild(this.var_124);
               this.var_54.mask = this.var_124;
            }
         }
         else if(!param1 && this.var_812)
         {
            this.var_812 = false;
            if(this.var_124 != null && this.var_245.contains(this.var_124))
            {
               this.var_245.removeChild(this.var_124);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_245.numChildren > 0)
            {
               this.var_245.removeChildAt(0);
            }
            this.var_245 = null;
         }
         this.var_54 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_606.length)
            {
               this.cleanSprite(this.var_606[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_606 = [];
         }
      ...
      {
         this.var_607.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_733 != this.var_2540 || this._ht != this.var_2537)
         {
            _loc9_ = true;
         }
         if(this.var_54.x != this.var_608 || this.var_54.y != this.var_604)
         {
            this.var_54.x = this.var_608;
            this.var_54.y = this.var_604;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2540 = this.var_733;
         this.var_2537 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_607.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_607.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_608;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_604;
                  if(_loc19_ < this.var_733 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_608;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_606.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_732 || this.var_732 == 0)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_244.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_244.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_608;
         param2 -= this.var_604;
         this.var_493.x = param1;
         this.var_493.y = param2;
         if(this.var_1129 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1797;
         }
         this.var_1797 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1129;
         return this.var_1797;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_733 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1798,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_605.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_605.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2539 || param2 != this.var_2538)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_605.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_605.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_337 != null && param1 != null)
         {
            this.var_337.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_337 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_337.getKey(_loc1_);
            _loc3_ = this.var_337.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1388.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1129 == 0)
         {
            this.checkMouseHits(this.var_493.x,this.var_493.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1129 = 0;
         ++this.var_1798;
      }
