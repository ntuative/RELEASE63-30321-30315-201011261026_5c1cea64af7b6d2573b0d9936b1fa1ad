package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_657:Number = 64;
      
      public static const const_931:Number = 32;
      ...
      private var var_950:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_350:Number = 1.0;
      
      private var var_351:Number = 1.0;
      
      private var var_352:Number = 1.0;
      
      private var var_1433:Number = 1.0;
      
      private var var_1431:Number = 1.0;
      
      private var var_1432:Number = 1.0;
      
      private var var_71:Vector3d;
      
      private var var_216:Vector3d;
      
      private var var_2602:Number = -500.0;
      
      private var var_2601:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_950 = new Vector3d();
         this.var_1433 = 1;
         this.var_1431 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1432 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_164.x,this.var_164.y,this.var_164.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_71.x * this.var_350,this.var_71.y * this.var_351,this.var_71.z * this.var_352);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_216.x,this.var_216.y,this.var_216.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_350 != param1 * this.var_1433)
         {
            this.var_350 = param1 * this.var_1433;
            ++this.var_133;
         }
      }
      ...
      {
         if(this.var_351 != param1 * this.var_1431)
         {
            this.var_351 = param1 * this.var_1431;
            ++this.var_133;
         }
      }
      ...
      {
         if(this.var_352 != param1 * this.var_1432)
         {
            this.var_352 = param1 * this.var_1432;
            ++this.var_133;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_71.x;
         var _loc3_:Number = this.var_71.y;
         var _loc4_:Number = this.var_71.z;
         this.var_71.assign(param1);
         this.var_71.x /= this.var_350;
         this.var_71.y /= this.var_351;
         this.var_71.z /= this.var_352;
         if(this.var_71.x != _loc2_ || this.var_71.y != _loc3_ || this.var_71.z != _loc4_)
         {
            ++this.var_133;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_216.x;
         var _loc3_:Number = this.var_216.y;
         var _loc4_:Number = this.var_216.z;
         this.var_216.assign(param1);
         if(this.var_216.x != _loc2_ || this.var_216.y != _loc3_ || this.var_216.z != _loc4_)
         {
            ++this.var_133;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_417 != null)
         {
            ...
            this.var_417.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_417.add(_loc3_,_loc4_);
            ++this.var_133;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_417 != null)
         {
            ...
            return this.var_417.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_950.assign(_loc22_);
         }
         else
         {
            this.var_950.assign(_loc17_);
         }
         ++this.var_133;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_71);
         _loc2_.x *= this.var_350;
         _loc2_.y *= this.var_351;
         _loc2_.z *= this.var_352;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_950);
         if(_loc3_ < this.var_2602 || _loc3_ > this.var_2601)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_71);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_350;
            _loc2_.y *= this.var_351;
            _loc2_.z *= this.var_352;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_950);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_165,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_71.x * this.var_350,this.var_71.y * this.var_351,this.var_71.z * this.var_352);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_164;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_350,param2.y * this.var_351,param2.z * this.var_352);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_350,param3.y * this.var_351,param3.z * this.var_352);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_350,param4.y * this.var_351,param4.z * this.var_352);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_931;
         }
         else
         {
            this.scale = const_657;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_657;
      }
