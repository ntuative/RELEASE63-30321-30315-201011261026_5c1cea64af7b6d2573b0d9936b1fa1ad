   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_223 != null)
         {
            ...
            {
               _loc3_ = this.var_223.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1239.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1239.push(param1);
         }
         if(this.var_543[param1] != param2)
         {
            this.var_543[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1238.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1238.push(param1);
         }
         if(this.var_546[param1] != param2)
         {
            this.var_546[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_515.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_515[_loc2_]);
      ...
      {
         return this.var_223.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_223.getValue(_loc2_) != null)
         {
            return this.var_223.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_223.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_223.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_223.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_223.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
