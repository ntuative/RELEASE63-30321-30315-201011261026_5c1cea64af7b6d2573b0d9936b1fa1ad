package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_614:Point;
      
      protected var var_1403:uint;
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this._window.addEventListener(WindowEvent.const_267,this.include);
            this._working = true;
         }
         return _loc3_;
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_267,this.include);
               }
               this._window = null;
               this._working = false;
            }
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_614);
         this._window.offset(this.var_614.x - this._offset.x,this.var_614.y - this._offset.y);
      }
      
      private function include(param1:WindowEvent) : void
      {
         this.end(this._window);
      }
