package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1527:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1196:String = "TAB_BUTTON_TITLE";
      
      private static const const_1526:String = "TAB_BUTTON_ICON";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1196));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
