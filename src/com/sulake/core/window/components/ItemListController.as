package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1107:String = "spacing";
      
      protected static const const_1105:String = "scale_to_fit_items";
      
      protected static const const_1106:String = "resize_on_item_update";
      
      protected static const const_1104:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1503:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1502:Boolean = true;
      ...
      protected var var_2642:Number = 0.0;
      
      protected var var_2641:Number = 0.0;
      
      protected var var_927:Boolean = true;
      
      protected var var_507:Boolean = false;
      
      protected var var_1165:Boolean = false;
      
      protected var var_1872:int = 0;
      
      protected var var_1870:int = 0;
      
      protected var var_1166:Number;
      
      protected var var_1167:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_98 = 0;
         this.var_89 = 0;
         this._horizontal = param2 == WindowType.const_378;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_149 = var_504 || !testParamFlag(WindowParam.const_32);
         this._container = var_17.create("_CONTAINER","",WindowType.const_334,WindowStyle.const_671,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_289,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_616 * this.maxScrollH,this.var_617 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_616 = param1;
            this._container.x = -this.var_616 * this.maxScrollH;
            var_17.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_78);
            dispatchEvent(new WindowEvent(WindowEvent.const_530,this,null));
         }
      }
      ...
      {
         this.var_2642 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2641 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_499,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            if(this.var_1164)
            {
               try
               {
                  var_17.getWindowServices().getGestureAgentService().end(this);
               }
               catch(e:Error)
               {
               }
            ...
            this._container.removeEventListener(WindowEvent.const_289,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_187:
               if(this.var_1164)
               {
                  this.var_1166 = this.var_1872 - _loc3_;
                  this.var_1167 = this.var_1870 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1167 != 0 && this.var_89 != 0)
                  {
                     this.scrollV += this.var_1167 / this.var_89;
                  }
                  this.var_1872 = _loc3_;
                  this.var_1870 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_183:
               if(this.var_1164)
               {
                  if(this._horizontal)
                  {
                     var_17.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1166,0);
                  }
                  else
                  {
                     var_17.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1167);
                  }
                  this.var_1164 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_927 && !this.var_506 && this._container)
         {
            this.var_506 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1107,this._spacing,PropertyStruct.const_53,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1104,this.var_927,PropertyStruct.const_55,this.var_927 != const_1502));
         _loc1_.push(new PropertyStruct(const_1105,this.var_507,PropertyStruct.const_55,this.var_507 != const_1503));
         _loc1_.push(new PropertyStruct(const_1106,this.var_1165,PropertyStruct.const_55,this.var_1165 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1106:
                  ...
                  break;
               case const_1104:
                  this.var_927 = _loc2_.value as Boolean;
                  break;
            }
         }
