package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1159:String = "_SELECTOR";
      
      private static const const_1158:String = "_CONTENT";
       
      
      protected var var_920:ITabSelectorWindow;
      
      protected var var_1857:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_920 = findChildByTag(const_1159) as ITabSelectorWindow;
            if(this.var_920 != null)
            {
               this.var_920.procedure = this.selectorEventProc;
            }
         }
         return this.var_920;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1857 = findChildByTag(const_1158) as IWindowContainer;
         }
      ...
      {
         return !!this.var_674 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_920.numSelectables;
      }
