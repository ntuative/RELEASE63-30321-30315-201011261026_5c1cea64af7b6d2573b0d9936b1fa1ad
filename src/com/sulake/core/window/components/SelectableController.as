package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
      ...
      {
         var _loc3_:* = null;
         if(param2.type == WindowNotifyEvent.const_324)
         {
            if(var_13)
            {
      ...
      public function select() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_363;
         this.update(this,_loc1_);
         activate();
         return true;
      }
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_660,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
