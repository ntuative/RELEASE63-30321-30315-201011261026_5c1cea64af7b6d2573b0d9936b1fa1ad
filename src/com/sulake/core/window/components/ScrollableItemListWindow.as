package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1092:IItemListWindow;
      
      private var var_388:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_72))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_388)
         {
            this.var_388.removeEventListener(WindowEvent.const_286,this.method_2);
            this.var_388.removeEventListener(WindowEvent.const_208,this.method_2);
            this.var_388 = null;
         }
         if(this.var_1092)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1092)
         {
            this.var_1092 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_388)
         {
            this.var_388 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_388)
            {
               this.var_388.addEventListener(WindowEvent.const_286,this.method_2);
               this.var_388.addEventListener(WindowEvent.const_208,this.method_2);
            }
         }
         return this.var_388;
      }
      
      private function method_2(param1:WindowEvent) : void
      {
