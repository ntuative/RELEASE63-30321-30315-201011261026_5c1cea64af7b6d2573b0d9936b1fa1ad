package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1215:String = "increment";
      
      private static const const_1216:String = "decrement";
      
      private static const const_858:String = "slider_track";
      
      private static const const_548:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_615:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_46,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_530,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_46,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_530,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_897 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_858) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_548) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_548:
         ...
         if(param2.type == WindowNotifyEvent.const_473)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_272)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_615;
                  }
                  else
                  {
                     this.scrollV -= this.var_615;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_444)
         {
            ...
            else if(param2.name == const_1216)
            {
               if(this.var_18)
               {
                  this.var_1117 = true;
            ...
            else if(param2.name == const_858)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_548).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_272)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_897) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_897) as IScrollableWindow;
               if(_loc1_)
               {
