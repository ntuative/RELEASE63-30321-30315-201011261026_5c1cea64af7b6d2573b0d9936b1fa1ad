package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private var var_163:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_527,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_591 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_363,this,null));
         }
      }
      ...
      {
         if(this.var_163 != null && !this.var_163.disposed)
         {
            this.var_163.destroy();
            this.var_163 = null;
         }
         super.dispose();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_163 == null || this.var_163.disposed)
         {
            this.var_163 = context.create(name + "::submenu","",WindowType.const_488,var_77,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_163.setGlobalRectangle(_loc1_);
         }
         this.var_163.activate();
         return this.var_163;
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_163.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_883 = false;
            this.getTitleText().text = this.var_591 < this._itemArray.length && this.var_591 > -1 ? this._itemArray[this.var_591] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_491,var_77,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_334,var_77,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_591 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_591).setStateFlag(WindowState.const_50,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_444)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_875:
            case WindowMouseEvent.const_58:
               ...
               break;
            case WindowTouchEvent.const_556:
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowEvent.const_984:
               if(param2 == this.var_163)
               {
                  this.closeMenuView();
               }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1102,this._itemArray,PropertyStruct.const_142,this._itemArray.length > 0));
         return _loc1_;
      }
