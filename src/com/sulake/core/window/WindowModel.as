package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_344:Rectangle;
      ...
      protected var var_406:uint = 16777215;
      
      protected var var_1153:uint;
      ...
      protected var var_717:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_77 = param4;
         this.var_751 = param8 == null ? new Array() : param8;
         this.var_17 = param6;
         this.var_11 = param7.clone();
         this.var_344 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this.var_17 = null;
            this._state = WindowState.const_422;
            this.var_751 = null;
         }
      }
      ...
      {
         return this.var_344.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_344.height;
      }
