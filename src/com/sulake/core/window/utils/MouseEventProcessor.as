package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_753:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_126 = param1.desktop;
         this.var_78 = param1.var_1146 as WindowController;
         this._lastClickTarget = param1.var_1145 as WindowController;
         this.var_138 = param1.renderer;
         this.var_753 = param1.var_1144;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_613.x || _loc3_.stageY != this.var_613.y)
            {
               this.var_613.x = _loc3_.stageX;
               this.var_613.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_126.groupParameterFilteredChildrenUnderPoint(this.var_613,_loc6_,WindowParam.const_28);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_78 != this.var_126 && !this.var_78.disposed)
                  {
                     ...
                     this.var_78 = WindowController(this.var_126);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_78 && !this.var_78.disposed)
                     {
                        ...
                        {
                           this.var_753.mouseEventReceived(_loc3_.type,this.var_78);
                        }
                     }
                  }
         ...
         param2.end();
         param1.desktop = this.var_126;
         param1.var_1146 = this.var_78;
         param1.var_1145 = this._lastClickTarget;
         param1.renderer = this.var_138;
         param1.var_1144 = this.var_753;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_463))
         {
