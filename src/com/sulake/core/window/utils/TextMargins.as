package com.sulake.core.window.utils
{
   ...
   public class TextMargins implements IMargins, IDisposable
   {
      ...
      {
         return this.var_1060 == 0 && this._right == 0 && this.var_1059 == 0 && this.var_1058 == 0;
      }
      
      public function clone(param1:Function) : TextMargins
      {
         return new TextMargins(this.var_1060,this.var_1059,this._right,this.var_1058,param1);
      }
