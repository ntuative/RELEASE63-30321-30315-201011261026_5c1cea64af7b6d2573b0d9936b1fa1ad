package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_484 = param1;
         if(this.var_484 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_484)
         {
            this._target.width = this.var_484;
         }
      }
      ...
      {
         this.var_482 = param1;
         if(this.var_482 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_482)
         {
            this._target.height = this.var_482;
         }
      }
      ...
      {
         return this.var_484 == int.MIN_VALUE && this.var_483 == int.MAX_VALUE && this.var_482 == int.MIN_VALUE && this.var_481 == int.MAX_VALUE;
      }
