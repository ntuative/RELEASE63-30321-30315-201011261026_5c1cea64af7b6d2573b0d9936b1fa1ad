package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_225:String = "Number";
      ...
      public static const const_205:String = "Map";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2611 = param3 == const_205 || param3 == const_142 || param3 == const_235 || param3 == const_213;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_205:
               ...
               _loc1_ = "<var key=\"" + this.var_539 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_213:
               ...
               break;
            case const_181:
               _loc1_ = "<var key=\"" + this.var_539 + "\" value=\"" + "0x" + uint(this.var_152).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_539 + "\" value=\"" + this.var_152 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
