package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1649:String = "_INCLUDE";
      
      public static const const_1593:String = "_TEMP";
      
      private static const const_1163:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1152);
         this.var_921 = new Dictionary();
         this.var_1401 = new Dictionary();
         ParamCodeTable.fillTables(this.var_921,this.var_1401);
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1163,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1401)
            {
               delete this.var_1401[_loc1_];
            }
            this.var_1859.dispose();
            this.var_1859 = null;
            this.var_17 = null;
            this._disposed = true;
         }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1152[param1.type];
