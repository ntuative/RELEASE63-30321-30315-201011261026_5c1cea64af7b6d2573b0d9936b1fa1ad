package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_330:String = "regular";
      ...
      private static var var_211:IEventDispatcher;
      ...
      private static function init() : void
      {
         var _loc1_:* = null;
         var_81 = new Map();
         var_211 = new EventDispatcher();
         _loc1_ = new TextStyle();
         _loc1_.name = const_330;
         _loc1_.color = 0;
         _loc1_.fontSize = "9";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_81[const_330],var_81[ITALIC],var_81[BOLD]];
            var_81.reset();
            var_81[const_330] = _loc5_[0];
