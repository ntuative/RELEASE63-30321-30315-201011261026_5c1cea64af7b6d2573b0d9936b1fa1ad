package com.sulake.core.window.utils
{
   public class TextStyle
   {
      ...
      public static const const_945:String = "underline";
      ...
      {
         return this.color == param1.color && this.fontFamily == param1.fontFamily && this.fontSize == param1.fontSize && this.fontStyle == param1.fontStyle && this.fontWeight == param1.fontWeight && this.kerning == param1.kerning && this.leading == param1.leading && this.letterSpacing == param1.letterSpacing && this.textDecoration == param1.textDecoration && this.textIndent == param1.textIndent;
      }
   }
}
