package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1101:String = "_COLORIZE";
      
      protected static const const_1495:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1269:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_309 = new Rectangle();
         if(_loc12_ != null)
         {
            var_344 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_55 = var_344.clone();
            var_11 = var_344.clone();
         ...
         if(_loc13_)
         {
            var_717 = _loc13_.blend;
            var_407 = _loc13_.treshold;
            if(var_504 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_406 != _loc13_.color)
            {
      ...
      {
         return this.var_752 != null ? this.var_752 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_504 = param1;
         var_406 = !!var_504 ? uint(var_406 | var_1153) : uint(var_406 & 16777215);
      ...
      {
         var_750 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_497,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_1153 = param1 & 4278190080;
         var_406 = !!var_504 ? uint(param1) : uint(param1 & 16777215);
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_78);
      }
      
      public function set blend(param1:Number) : void
      {
         var_717 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_921);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_533,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_309 = this.var_13.rectangle.clone();
               var_55.x = var_11.x;
               var_55.y = var_11.y;
               var_55.width = var_11.width;
               var_55.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_473,this,this.var_13));
            }
            else
            {
               this.var_309.x = 0;
               this.var_309.y = 0;
               this.var_309.width = 0;
               this.var_309.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_968,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_77,_param,var_17,var_11,null,this.var_752,this.properties,var_751.concat(),_id) as WindowController;
         _loc2_.var_407 = var_407;
         _loc2_.var_149 = this.var_149;
         _loc2_._debug = this._debug;
         _loc2_.var_309 = this.var_309.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_344 = var_344.clone();
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_17.invalidate(this,param1,WindowRedrawFlag.const_78);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_948,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_667,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      {
         return !testParamFlag(WindowParam.const_32) ? this.getGraphicContext(true).fetchDrawBuffer() : (this.var_13 != null ? this.var_13.fetchDrawBuffer() : null);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_695))
         {
            ...
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  if(testParamFlag(WindowParam.const_347))
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_234))
                        {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_259))
                        {
               ...
               case WindowMouseEvent.const_58:
                  ...
                  if(testParamFlag(WindowParam.const_234))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_163:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_405,this,null));
                     if(testParamFlag(WindowParam.const_182,WindowParam.const_146))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_172,WindowParam.const_145))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
                     {
                        _loc9_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_499))
                        {
               ...
               case WindowNotifyEvent.const_531:
                  var_17.invalidate(this,var_11.union(var_55),WindowRedrawFlag.const_458);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1023,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_281,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_324:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_610,this,null));
                     if(this.var_13 != null)
                     {
               ...
               case WindowNotifyEvent.const_533:
                  var_17.invalidate(this,var_11,WindowRedrawFlag.const_937);
                  break;
               case WindowNotifyEvent.const_532:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1495) == -1)
                     {
                        _loc8_.style = var_77;
                     }
                  }
               ...
               case WindowNotifyEvent.const_497:
                  if(!(_param & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        var_17.invalidate(this,var_11,WindowRedrawFlag.const_458);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_405:
                  this.var_13.getRegionProperties(null,this.var_309);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1069:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1429:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1278:
               _loc2_ = "null";
               break;
         ...
         if(this.var_149 && var_407 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1269,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1269,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_118,WindowParam.const_146);
         var _loc2_:* = !testParamFlag(WindowParam.const_134,WindowParam.const_145);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_309.width;
               ...
               {
                  if(this.var_13.width < _loc3_.width && this.getParamFlag(WindowParam.const_32))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_309.height;
               _loc5_ = uint(_param & 0);
               ...
               {
                  if(this.var_13.height < _loc3_.height && this.getParamFlag(WindowParam.const_32))
                  {
                     _loc3_.y = 0;
                  }
                  else
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_914;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1069;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_670;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1270 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_325,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1270 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_781,this,param1));
         return param1;
      }
