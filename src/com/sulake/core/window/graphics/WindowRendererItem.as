package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_541:uint = 0;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_825 = 0;
         this.var_1596 = new ColorTransform();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_829) : uint(const_541);
         var _loc6_:Boolean = this.var_157.width > 0 && this.var_157.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_825))
            {
               _loc5_ = const_828;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_828)
               {
                  ...
                  if(this.var_566)
                  {
                     ...
                     _loc7_.draw(param1,this.var_92,this.var_92.rect,this.var_825,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     this.var_1596.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_92,this.var_925,this.var_1596,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_282)
            {
               _loc2_ = this.var_824.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_282);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_824.getTheActualState(param1.type,param1.style,param1.state) != this.var_1280;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_937:
               this.var_825 = this.var_824.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_825 != this.var_1280)
               {
                  this.var_566 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_921:
               ...
               break;
            case WindowRedrawFlag.const_904:
               _loc4_ = true;
         }
         if(_loc4_)
         {
