   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_505[_loc1_]).dispose();
            ...
            {
               ISkinTemplate(this.var_346[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinTemplate = this.var_346[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_505[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_346[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_410)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_410[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_505[param1.name];
         }
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_346[param1.name];
         }
         return param1;
      }
   }
