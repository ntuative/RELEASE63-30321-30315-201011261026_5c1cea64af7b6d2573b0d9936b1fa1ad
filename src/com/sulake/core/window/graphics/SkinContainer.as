package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_810:uint = 8;
      
      private static const const_1137:String = "skin";
      
      private static const const_1139:String = "bitmap";
      
      private static const const_1136:String = "fill";
      
      private static const const_1134:String = "text";
      
      private static const const_1138:String = "shape";
      
      private static const const_1135:String = "unknown";
      
      private static const const_1140:String = "null";
      
      protected static var var_286:Array;
      ...
      private var var_2006:Dictionary;
      
      private var var_2005:Dictionary;
      
      private var var_2007:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2006 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1472,this.var_2006);
         this.var_2005 = new Dictionary();
         this.var_2007 = new Dictionary();
         StateCodeTable.fillTables(this.var_2005,this.var_2007);
         this.var_424 = new Dictionary();
         this.var_424[const_1137] = BitmapSkinRenderer;
         this.var_424[const_1139] = BitmapDataRenderer;
         this.var_424[const_1136] = FillSkinRenderer;
         this.var_424[const_1134] = TextSkinRenderer;
         this.var_424[const_1138] = ShapeSkinRenderer;
         this.var_424[const_1135] = SkinRenderer;
         this.var_424[const_1140] = NullSkinRenderer;
         if(var_286 == null)
         {
            var_286 = new Array();
            var_286.push(WindowState.const_66);
            var_286.push(WindowState.const_72);
            var_286.push(WindowState.const_85);
            var_286.push(WindowState.const_50);
            var_286.push(WindowState.WINDOW_STATE_HOVERING);
            var_286.push(WindowState.const_81);
            var_286.push(WindowState.const_100);
            var_286.push(WindowState.const_90);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1472[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_774[param1] = new Array(const_810);
         }
         this.var_774[param1][param2] = param3;
         if(this.var_775[param1] == null)
         {
            this.var_775[param1] = new Array(const_810);
         }
         this.var_775[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_774[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_282)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_775[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_282)
