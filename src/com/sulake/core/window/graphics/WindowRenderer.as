package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1258:Rectangle;
      
      private var var_267:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1565 = new Point();
         this.var_1258 = new Rectangle();
         this.var_267 = new Rectangle();
         this.var_303 = new Dictionary(true);
         this.var_824 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_659 = null;
            for(_loc1_ in this.var_303)
            {
               delete this.var_303[_loc1_];
            }
            this.var_303 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_267.x = param2.x - param1.x;
            this.var_267.y = param2.y - param1.y;
            this.var_267.width = param2.width;
            this.var_267.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  this.var_267.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_267,WindowRedrawFlag.const_904);
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_78);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_303[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_303[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_303[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_633,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_633,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_303[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_303[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_659.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_659.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_267.x = _loc3_.dirty.x;
               this.var_267.y = _loc3_.dirty.y;
               this.var_267.width = _loc3_.dirty.width;
               this.var_267.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_267,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1565,this.var_1258))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1565,this.var_1258))
               {
                  ...
                  while(_loc8_ < _loc4_)
                  {
                     ...
                     else if(!_loc5_.testParamFlag(WindowParam.const_32))
                     {
            ...
            else if(!param1.testParamFlag(WindowParam.const_32))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1258);
