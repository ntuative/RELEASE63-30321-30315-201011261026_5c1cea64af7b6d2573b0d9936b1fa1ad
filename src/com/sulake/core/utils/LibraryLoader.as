package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1497:uint = 1;
      
      protected static const const_1498:uint = 2;
      
      protected static const const_1496:uint = 4;
      
      protected static const const_1499:uint = 3;
      ...
      protected var var_631:XML;
      
      protected var var_528:Class;
      
      protected var var_408:uint = 0;
      
      protected var _name:String;
      
      protected var var_922:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_923:Boolean = false;
      
      protected var var_2589:String = "";
      
      protected var var_2588:String = "";
      
      protected var var_1860:int;
      
      protected var var_1154:int;
      
      protected var var_1155:int;
      
      protected var var_2668:uint = 0;
      
      protected var var_2590:Boolean = true;
      ...
      {
         return !!this.var_922 ? uint(this.var_1154 - this.var_1860) : uint(getTimer() - this.var_1860);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_345,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_38.close();
            }
      ...
      {
         if(this.var_923 && !_disposed)
         {
            this.var_923 = false;
            if(!this.var_922 && this.var_250)
            {
               this.var_1154 = -1;
               this.var_1860 = getTimer();
               this.var_38.load(this.var_250,this.var_17);
            }
         }
      }
      ...
      {
         if(!this.var_922 && !_disposed && this.var_1155 > 0)
         {
            try
            {
               this.var_38.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_250,const_1439 - this.var_1155);
            if(this.var_2590)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               this.var_345 = HTTPStatusEvent(param1).status;
               this.debug("Load event STATUS " + this.var_345 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_345,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_345,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_345))
               {
                  this.var_1154 = getTimer();
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_408 = LibraryLoader.name_2;
         ...
         if(this.var_408 == LibraryLoader.const_1499)
         {
         ...
         if(this.var_408 == LibraryLoader.name_2)
         {
            if(this.prepareLibrary())
            {
               ...
               this.var_1154 = getTimer();
               this.removeEventListeners();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_345,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_528 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_528.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_631 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_345,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_345,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
