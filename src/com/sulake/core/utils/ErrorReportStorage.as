package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_982:Map = new Map();
      
      private static var var_644:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_644.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_644.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_644.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
