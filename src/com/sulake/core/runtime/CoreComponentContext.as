package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1128:String = "service-libraries";
      ...
      private var var_289:LibraryLoaderQueue;
      
      private var var_217:Profiler;
      
      private var var_628:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_419.push(new Array());
            this.var_526.push(0);
            _loc3_++;
         }
         this.var_1448 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_409.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1004:
            ...
            case Core.const_1466:
               ...
               var_409.addChild(new ProfilerViewer(this.var_217));
               break;
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_409.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_409 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_141)
            {
               _loc2_ = this.var_419[_loc3_] as Array;
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_628 = loadingEventDelegate;
         if(this.var_289 == null)
         {
            this.var_289 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         try
         {
            node = config.child(const_1128)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1473);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_628)
         {
            this.var_628.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_628)
         {
            ...
            this.var_628.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_628)
                  {
                     this.var_628.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_420 - this.var_289.length,this.var_420,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_419[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_419[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_418(_loc2_,_loc2_ - this.var_1448);
         this.var_1448 = _loc2_;
      }
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_526[criticality] = 0;
            receivers = this.var_419[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_409.stage.frameRate;
         criticality = 0;
         while(criticality < CoreComponentContext.const_141)
         {
            t = getTimer();
            ...
            {
               if(this.var_526[criticality] < criticality)
               {
                  ++this.var_526[criticality];
                  skip = true;
               }
            }
            if(!skip)
      ...
      private function debugFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(_loc3_ < CoreComponentContext.const_141)
         {
            this.var_526[_loc3_] = 0;
            _loc4_ = this.var_419[_loc3_];
            _loc7_ = 0;
