package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1151 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1151);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1403 & const_1070)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_731 + "]";
      }
