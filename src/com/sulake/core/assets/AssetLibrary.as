package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_683:String = "AssetLibraryLoaded";
      
      public static const const_1298:String = "AssetLibraryUnloaded";
      
      public static const const_1441:String = "AssetLibraryLoadError";
      ...
      private static var var_771:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_631 = new XML();
         this.var_356 = 0;
         this.var_357 = new Array();
         if(var_260 == null)
         {
            var_260 = new Dictionary(false);
         ...
         this.var_422 = new Dictionary(false);
         this.var_773 = new Dictionary(false);
         this.var_134 = new Dictionary(false);
         var_771.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_771.splice(var_771.indexOf(this),1);
            --var_423;
            this.var_422 = null;
            this.var_773 = null;
            this.var_134 = null;
      ...
      {
         if(this._file == param1.url && this.var_772)
         {
            if(!this.var_770 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_631,this.var_528);
            }
            this.var_770 = param2;
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = this.var_422[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_422[_loc1_];
         }
         for(_loc1_ in this.var_134)
         {
            delete this.var_134[_loc1_];
         }
         for(_loc1_ in this.var_773)
         {
            delete this.var_773[_loc1_];
         }
         if(this.var_38 != null)
         {
            this.var_38.dispose();
      ...
      {
         var _loc2_:Class = this.var_773[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_422[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1055,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_929,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1085,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_874,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_422[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_422[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_31:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_134[struct.assetName] == null)
                  {
                     ++this.var_356;
                     this.var_357.push(struct.assetName);
                  }
                  this.var_134[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_45,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_422[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_134[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return this.var_134[param1] != null || (this.var_528 != null ? this.var_528[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_134[param1] == null;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_260.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_260[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_260[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_260)
            {
               _loc3_ = AssetTypeDeclaration(var_260[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_260)
            {
               _loc4_ = AssetTypeDeclaration(var_260[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_631 = _loc2_.manifest.copy();
         this.var_528 = _loc2_.resource;
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_631.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_528[param1]);
