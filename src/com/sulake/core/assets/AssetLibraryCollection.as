package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_499:Array;
      
      protected var var_926:LoaderContext;
      
      protected var var_403:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_926 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_403 = new AssetLibrary("lib-" + this.var_509++);
         this.var_27.push(this.var_403);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_926;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_509++);
         this.var_499.push(_loc3_);
      ...
      {
         return this.var_403.loadFromResource(param1,param2);
      }
      
      public function unload() : void
      {
         while(this.var_499.length > 0)
         {
            (this.var_499.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_499.length)
            {
               _loc3_ = this.var_499[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_499.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return this.var_403.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_403.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_403.createAsset(param1,param2);
      }
      ...
      {
         return this.var_403.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_403.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_403.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_27.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_403.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_27.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
