package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_458:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_458 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_107 is BitmapDataAsset)
         {
            ...
            this.var_1278 = BitmapDataAsset(this.var_107).var_1278;
            this.var_1279 = BitmapDataAsset(this.var_107).var_1279;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1278 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1279 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
