package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_926 = new LoaderContext();
         this.var_926.checkPolicyFile = true;
         ...
         {
            this.var_38.load(param2,this.var_926);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_284 = 0;
         this.var_38.load(param1,this.var_926);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_284 < var_2579)
            {
               ...
               this.var_38.load(new URLRequest(this.var_924 + (this.var_924.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_284),this.var_926);
               return true;
            }
         }
         return false;
