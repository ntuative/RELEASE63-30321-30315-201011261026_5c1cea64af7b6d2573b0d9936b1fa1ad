package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_674 = (param2 & 0) > 0;
         this.var_1031 = new Dictionary();
         if(!this.var_674)
         {
            lock();
         }
         ...
         this.var_568 = this.getKey("url_prefix");
         if(this.var_568 != null && this.var_568.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_568 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function init() : void
      {
         ...
         if(!this.var_674)
         {
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_31,this.onInitConfiguration);
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc4_ && _loc4_ != "")
         {
            ...
            _loc6_.addEventListener(AssetLoaderEvent.const_31,this.onInitConfigurationOverride);
            _loc6_.addEventListener(AssetLoaderEvent.const_45,this.onConfigurationOverrideError);
         }
         else if(!this.var_674)
         {
            this.var_674 = true;
            if(locked)
            {
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_568 = this.getKey("url.prefix");
         if(this.var_568.length > 0)
         {
            externalAccessDomain = this.var_568.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_1031[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1031[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_568);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         if(param3)
         {
            if(this.var_1031[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1607.indexOf(param1) < 0)
         {
