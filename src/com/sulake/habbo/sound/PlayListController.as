package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1791:String = "type_sound_machine";
      
      private const const_1513:String = "type_jukebox";
      
      private var var_589:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_759,this.onSoundMachinePlayEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_728,this.onSoundMachineStopEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_684,this.onJukeboxInitEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_490,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_85)
            {
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_759,this.onSoundMachinePlayEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_728,this.onSoundMachineStopEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_684,this.onJukeboxInitEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_490,this.onDisposeEvent);
               this.var_85 = null;
            }
            if(this.var_366)
            {
      ...
      {
         this.startPlaying(this.const_1791);
      }
      ...
      {
         this.startPlaying(this.const_1513);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(this.var_72 == null || this.var_72.length == 0)
         {
         ...
         if(_loc2_ != null)
         {
            this.var_266 = _loc2_.id;
            this.playSong(this.var_266);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_366[this.var_266] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_366.getValue(this.var_266) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_266 = param1;
         var _loc2_:IHabboSound = this.var_366.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_589.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_589.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_266)
         {
            _loc6_ = this.var_366[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1527 == this.const_1513)
         {
            this.var_72.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function getNextEntry() : PlayListEntry
      {
         ...
         {
            _loc2_ = this.var_72[_loc3_];
            if(_loc2_.id == this.var_266)
            {
               _loc1_ = _loc3_ + 1;
            }
            _loc3_++;
         }
         if(_loc1_ >= this.var_72.length)
         {
            _loc1_ = 0;
         }
         return this.var_72[_loc1_];
      }
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_547.indexOf(param1) == -1)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_72.length)
            {
               _loc6_ = this.var_72[_loc5_] as PlayListEntry;
               if(_loc6_.id == _loc3_.id)
               {
                  this.var_72.splice(_loc5_,1);
                  _loc4_ = false;
                  break;
               }
               _loc5_++;
         ...
         this.var_547 = this.var_547.splice(this.var_547.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_366[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_589.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_366.add(_loc3_.id,_loc7_);
            }
      ...
      private function onPlayListSongAddedMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_72.push(_loc4_);
         if(this.var_72.length == 1)
         {
