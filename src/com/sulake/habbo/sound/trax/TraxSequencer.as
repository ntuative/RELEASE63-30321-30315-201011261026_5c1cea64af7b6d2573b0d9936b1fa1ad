package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private static const const_1145:uint = 88200;
      
      private static const const_1144:uint = 88200;
      ...
      private var var_1216:Sound;
      
      private var _soundChannel:SoundChannel;
      
      private var var_1483:TraxData;
      ...
      {
         this.var_1482 = uint(const_258 / 44.1);
         super();
         this._events = param4;
         this.var_2023 = param1;
         this.var_445 = 1;
         this.var_1216 = new Sound();
      ...
      public function play() : Boolean
      {
         ...
         this.var_1215 = false;
         this.var_1216.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1216.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1216.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      public function set volume(param1:Number) : void
      {
         ...
         if(this._soundChannel != null)
         {
            this._soundChannel.soundTransform = new SoundTransform(this.var_445);
         }
      }
      ...
      {
         return Math.ceil(param1 / const_1145);
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1483.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1483.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1481.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         var _loc4_:* = [];
         var _loc5_:* = null;
         var _loc6_:int = this.var_635.length;
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc2_.push(this.var_635[_loc7_].getKeys());
            _loc12_ = 0;
            ...
            _loc13_ = this.var_635[_loc7_].getWithIndex(_loc12_);
         ...
         while(_loc7_ >= 0)
         {
            ...
            while(_loc18_ < _loc17_)
            {
               ...
               if(_loc18_ < _loc17_)
               {
                  if(_loc16_ < this.var_635[_loc7_].length - 1)
                  {
                     _loc21_ = this.var_635[_loc7_].getWithIndex(++_loc16_);
                     if(_loc21_.id == 0)
                     {
                        _loc5_ = null;
                     }
         ...
         this.var_190 += const_258;
         if(this._soundChannel != null)
         {
            this.var_1482 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_190 > this._length + this.var_1482 * 44.1)
         {
            this.var_1215 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_679,this.var_2023));
      }
   }
}
