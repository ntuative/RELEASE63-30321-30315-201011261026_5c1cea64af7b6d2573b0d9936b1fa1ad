package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_719.addEventListener(WindowKeyboardEvent.const_153,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_50.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_336,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_50.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_50.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_373.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_373.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(this.var_50.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
