package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1753:int = "F".charCodeAt(0);
      
      public static const const_1600:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_834 = param1.gender;
         this.var_743 = param1.online;
         this.var_1589 = param1.followingAllowed && param1.online;
         this.var_574 = param1.figure;
         this.var_1698 = param1.motto;
         this.var_1700 = param1.lastAccess;
         this.var_1214 = param1.categoryId;
