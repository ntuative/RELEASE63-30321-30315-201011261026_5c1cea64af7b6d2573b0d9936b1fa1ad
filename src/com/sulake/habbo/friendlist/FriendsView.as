package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_791:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2065:IContainerButtonWindow;
      
      private var var_2063:IContainerButtonWindow;
      
      private var var_2066:IContainerButtonWindow;
      
      private var var_2064:IContainerButtonWindow;
      
      private var var_50:IItemListWindow;
      
      private var var_373:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_373 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2065 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2063 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2066 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2064 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_91).setNewMessageArrived(true);
      }
      ...
      public function refreshList() : void
      {
         ...
         this.var_50.autoArrangeItems = false;
         var _loc1_:int = 0;
         ...
         this.var_50.autoArrangeItems = true;
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_50.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_50.addListItem(_loc6_);
         }
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_791);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_91,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_791);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_91,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2065,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2063,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2066,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2064,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_373.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_373.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_373.closePopup();
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_91,param4);
         _loc6_.visible = true;
      }
