package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_114:IHabboMessenger;
      ...
      private var var_716:ISessionDataManager;
      
      private var var_2504:FriendListLookAndFeel;
      
      private var var_380:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1782:OpenedToWebPopup;
      
      private var var_1923:int;
      
      var var_90:FriendCategories;
      
      private var var_335:FriendRequests;
      
      private var var_1783:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_804:IHabboNotifications;
      
      private var var_601:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2504 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_90 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1783 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_114)
         {
            this.var_114.release(new IIDHabboMessenger());
            this.var_114 = null;
         }
         if(this.var_158)
         {
         ...
         if(this.var_1124)
         {
            this.var_1124.release(new IIDAvatarRenderManager());
            this.var_1124 = null;
         }
         if(this.var_804)
         {
            this.var_804.release(new IIDHabboNotifications());
            this.var_804 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_716)
         {
            this.var_716.release(new IIDSessionDataManager());
            this.var_716 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1782 = new OpenedToWebPopup(this);
         }
         this.var_1782.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_90.findFriend(param1);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_91);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_90.getFriendCount(param1,param2);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_335.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_291,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1124.createAvatarImage(param1,AvatarScaleType.const_83,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_158.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_158.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_114 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1124 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_804 = param2 as IHabboNotifications;
      ...
      {
         this.var_716 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_335 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_90.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_90.addCategory(new FriendCategory(FriendCategory.const_890,this.getText("friendlist.friends")));
         this.var_90.addCategory(new FriendCategory(FriendCategory.const_320,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_90.addFriend(new Friend(_loc4_));
         }
         this.var_380 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_601)
         {
         ...
         if(this.var_90.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_90.findCategory(FriendCategory.const_320);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_380.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_332));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_335.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_335.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_380.findTab(FriendListTab.const_92).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_335.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_380.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1783.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_90.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_90.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_380.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_716 || !this.var_335)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_716.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_335.vipLimit;
         }
         else if(this.var_716.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_335.clubLimit;
         }
         if(_loc2_ > this.var_335.limit)
         {
            this.var_335.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_90.getAllFriends();
