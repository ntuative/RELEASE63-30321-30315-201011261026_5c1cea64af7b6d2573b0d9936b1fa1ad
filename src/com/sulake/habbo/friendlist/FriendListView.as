package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1523:String = "noconvinfo";
      
      private static const const_1522:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1303:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1303 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_768 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_237 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1303.prepare(this.var_768);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_910,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_966,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_768,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_706,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_768,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_706,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1302 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1302.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1637 == -1 ? 0 : int(this.var_16.height - this.var_1637);
         var _loc4_:int = this.var_1636 == -1 ? 0 : int(this.var_16.width - this.var_1636);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_998,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_768,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_910,false);
         ...
         this.var_1637 = this.var_16.height;
         this.var_1636 = this.var_16.width;
