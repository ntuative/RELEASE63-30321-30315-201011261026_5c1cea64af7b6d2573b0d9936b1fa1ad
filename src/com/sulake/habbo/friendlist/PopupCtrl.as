package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_368 = new Timer(500,1);
         this.var_297 = new Timer(100,1);
         super();
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_47 == null)
         {
            this.var_47 = IWindowContainer(this._friendList.getXmlWindow(this.var_1251));
         ...
         this.var_47.x = _loc4_.x - _loc3_.x + this.var_2099 + param2.width;
