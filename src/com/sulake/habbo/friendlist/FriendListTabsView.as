package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_153.width = this._friendList.tabs.tabContentWidth;
         this.var_153.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.getTabs())
         {
            _loc4_ = this.var_153.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_153.height = _loc2_ + 1;
         this.var_153.findChildByName("bg").height = this.var_153.height;
      ...
      private function refreshTabContent(param1:FriendListTab, param2:IWindowContainer) : void
      {
         if(param1.selected)
         {
            if(param1.view == null)
            {
               param1.view = this.method_5(param1) as IWindowContainer;
            }
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         var _loc4_:Boolean = param1.id == FriendListTab.const_91 && !param1.newMessageArrived;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_332);
         }
      }
      
      private function method_5(param1:FriendListTab) : IWindow
      {
