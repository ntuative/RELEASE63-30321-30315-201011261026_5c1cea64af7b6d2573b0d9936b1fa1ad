package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1528:String = "no_reqs_info";
      ...
      private var var_1701:IContainerButtonWindow;
      
      private var var_1702:IContainerButtonWindow;
      ...
      {
         this.var_1701 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1702 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1702.procedure = this.onDismissAllButtonClick;
         this.var_1701.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_356)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_965)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_50.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_50.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_356;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_290,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_327 && _loc4_.state != FriendRequest.const_356)
            {
               _loc4_.state = FriendRequest.const_356;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_290,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1701,_loc1_);
         this.setEnabled(this.var_1702,_loc1_);
      }
