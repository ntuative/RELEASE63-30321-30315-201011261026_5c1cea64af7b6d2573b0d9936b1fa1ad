package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_835:uint = 11;
      ...
      private var var_1033:IHabboWindowManager;
      ...
      private var var_570:FramerateTracker = null;
      
      private var var_229:LatencyTracker = null;
      
      private var var_569:LagWarningLogger = null;
      
      private var var_571:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_230 = new PerformanceTracker();
         this.var_570 = new FramerateTracker();
         this.var_229 = new LatencyTracker();
         this.var_569 = new LagWarningLogger();
         this.var_571 = new ToolbarClickTracker(this);
         this.var_1292 = new Array(const_835);
         var _loc4_:int = 0;
         while(_loc4_ < const_835)
         {
            this.var_1292[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1376,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1310,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1231,Capabilities.serverString);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1033)
            {
               this.var_1033.release(new IIDHabboWindowManager());
               this.var_1033 = null;
            }
            if(this.var_265)
            {
            ...
            if(this.var_180)
            {
               if(!this.var_180.disposed)
               {
                  ...
                  Component(this.var_180).events.removeEventListener(HabboFriendListTrackingEvent.const_332,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._toolbar)
            {
               ...
               {
                  this._toolbar.events.removeEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
               }
      ...
      {
         this.var_1292[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_158 = IHabboConfigurationManager(param2);
         if(this.var_158)
         {
            if(this.var_229 != null)
            {
               this.var_229.configuration = this.var_158;
            }
            if(this.var_230 != null)
            {
               this.var_230.configuration = this.var_158;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1268);
            if(this.var_158)
            {
               if(this.var_569 != null)
               {
                  this.var_569.configure(this.var_158);
               }
               if(this.var_570 != null)
               {
                  this.var_570.configure(this.var_158);
               }
               if(this.var_571 != null)
               {
                  this.var_571.configure(this.var_158);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_148);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_655,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_165,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_226,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_206,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_614,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_230 != null)
            {
               this.var_230.connection = param1;
            }
            if(this.var_229 != null)
            {
               this.var_229.communication = this._communication;
               this.var_229.connection = param1;
            }
            if(this.var_569 != null)
            {
               this.var_569.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_614)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1404);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1373);
               break;
            case HabboCommunicationEvent.const_655:
               this.trackLoginStep(HabboLoginTrackingStep.const_1348,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_226:
               ...
               break;
            case HabboCommunicationEvent.const_206:
               this.trackLoginStep(HabboLoginTrackingStep.const_206);
         }
         if(this._communication)
         {
      ...
      {
         this.var_1033 = IHabboWindowManager(param2);
         if(this.var_1033)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_158)
            {
               if(this.var_158.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_158.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1292)
                  {
                  ...
                  if(this.var_230 != null)
                  {
                     _loc4_["null"] = this.var_230.flashVersion;
                     _loc4_["null"] = this.var_230.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_955);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_955,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_180).events.addEventListener(HabboFriendListTrackingEvent.const_332,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_332:
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_299,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_265 = param2 as IAdManager;
         this.var_265.events.addEventListener(AdEvent.const_411,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._toolbar = param2 as IHabboToolbar;
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_571)
         {
            this.var_571.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_158 != null && !Boolean(this.var_158.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_569.chatLagDetected();
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_1034 > -1 && _loc2_ < this.var_1034)
         {
            ++this.var_1614;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1614);
         }
         if(this.var_1034 > -1 && _loc2_ - this.var_1034 > 15000)
         {
            ++this.var_1613;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1613);
         }
         this.var_1034 = _loc2_;
         if(this.var_230 != null)
         {
            this.var_230.update(param1);
         }
         if(this.var_229 != null)
         {
            this.var_229.update(param1);
         }
         if(this.var_570 != null)
         {
            this.var_570.trackUpdate(param1,this);
         }
         if(this.var_569 != null)
         {
            this.var_569.update();
