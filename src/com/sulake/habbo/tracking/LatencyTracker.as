package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         if(this.var_158 == null || this._communication == null || this._connection == null)
         {
            return;
         }
         this.var_1508 = int(this.var_158.getKey("latencytest.interval"));
         this.var_1509 = int(this.var_158.getKey("latencytest.report.index"));
         this.var_2061 = int(this.var_158.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint) : void
      {
         ...
         if(getTimer() - this.var_1510 > this.var_1508)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_540.add(this.var_1232,this.var_1510);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1232));
         ++this.var_1232;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_540 == null || this.var_194 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_540.getValue(_loc2_.requestId);
         this.var_540.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_194.push(_loc4_);
         if(this.var_194.length == this.var_1509 && this.var_1509 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1507) > this.var_2061 || this.var_1507 == 0)
            {
               this.var_1507 = _loc9_;
