package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectSoundMachineStateUpdateEvent extends RoomObjectEvent
   {
      ...
      public static const const_759:String = "ROSM_SOUND_MACHINE_SWITCHED_ON";
      
      public static const const_728:String = "ROSM_SOUND_MACHINE_SWITCHED_OFF";
      
      public static const const_684:String = "ROSM_JUKEBOX_INIT";
