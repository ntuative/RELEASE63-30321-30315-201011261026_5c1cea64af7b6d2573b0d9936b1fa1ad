package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_543:String = "temporary_room";
      
      private static const const_309:int = -1;
      
      private static const const_544:String = "room";
      ...
      private var var_866:IRoomRendererFactory = null;
      
      private var var_25:IRoomObjectFactory = null;
      
      private var var_413:IRoomObjectVisualizationFactory = null;
      
      private var var_265:IAdManager = null;
      
      private var var_363:ISessionDataManager = null;
      
      private var var_113:IHabboConfigurationManager;
      ...
      private var var_694:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_694 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_413.release(new IIDRoomObjectVisualizationFactory());
            this.var_413 = null;
         }
         if(this.var_41 != null)
         {
         ...
         {
            this.var_866.release(new IIDRoomRendererFactory());
            this.var_866 = null;
         }
         ...
         {
            this.var_113.release(new IIDHabboConfigurationManager());
            this.var_113 = null;
         }
         if(this.var_265)
         {
         ...
         if(this.var_323 != null)
         {
            ...
            {
               _loc2_ = this.var_323.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_323.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_323.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = this.var_41.getRoom(this.getRoomIdentifier(this.var_95,this.var_96));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_323.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_95 || _loc6_ != this.var_96 || !this.var_1089)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_598) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_790) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_801) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_785) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_413 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_15 != null)
         {
            this.var_15.visualizationFactory = this.var_413;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_41 != null)
         {
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_29);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_27);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_35);
            this.var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_260);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_866 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_113 = param2 as IHabboConfigurationManager;
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_638,this.onContentLoaderReady);
            this.var_15.initialize(events,this.var_113);
         }
         this.initializeRoomManager();
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_638)
         {
            this.var_2394 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_265.events.addEventListener(AdEvent.const_411,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_363 = param2 as ISessionDataManager;
         this.var_15.sessionDataManager = this.var_363;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_25 != null)
         {
            ...
            {
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_251,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_408,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_169,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_580,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_136,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_131,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_433,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_436,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_507,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_404,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_393,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_462,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_413,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_59,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_471,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_521,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_299,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_452,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_361,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_369,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_492,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_1049,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_465,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_25 == null || this.var_413 == null || this.var_41 == null || this.var_866 == null || this._communication == null || this.var_113 == null || !this.var_2394)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = this.var_324.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_962,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_432,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_962);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_472)
         {
            _loc5_ = this.var_324.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_324.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_676,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_309,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1042,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_590,1,true);
            _loc13_ = parseInt(this.var_113.getKey("ads.billboard.displayDelayMillis","1000"));
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_309,const_544,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_590,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_698,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_598,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_801,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_790,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_785,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_961,_loc14_,true);
               }
            }
         }
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_600,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_802,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_493,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_204);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_685,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_597,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_685,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_597,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1045,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_849,const_1198,RoomObjectCategoryEnum.const_260);
         _loc7_.createRoomObject(const_850,const_1199,RoomObjectCategoryEnum.const_260);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_309,RoomObjectCategoryEnum.const_74);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_324.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_324.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_600,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_802,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1337,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1021,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1082,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_323.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_866.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_900;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_698);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_685);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_597);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1045);
      ...
      {
         var _loc8_:int = param2 - this.var_1346;
         var _loc9_:int = param3 - this.var_1347;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1089 = true;
               this.var_865 = false;
               this.var_2393 = this.var_1346;
               this.var_2395 = this.var_1347;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1089)
            {
               if(!this.var_865)
               {
                  _loc8_ = param2 - this.var_2393;
                  _loc9_ = param3 - this.var_2395;
                  if(_loc8_ <= -const_387 || _loc8_ >= const_387 || _loc9_ <= -const_387 || _loc9_ >= const_387)
                  {
                     this.var_865 = true;
                  }
                  _loc8_ = 0;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_431,this.var_95,this.var_96,-1,RoomObjectCategoryEnum.const_144));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_67 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_309,const_544);
                     this.var_67.handleRoomObjectEvent(_loc14_,this.var_95,this.var_96);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = this.getRoomObjectImage(this.var_95,this.var_96,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_96,this.var_1348);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1346 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1347 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_96,this.var_1348);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_96,this.var_1348);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_67 != null)
         {
            return this.var_67.modifyRoomObject(this.var_95,this.var_96,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_67 != null)
         {
            ...
            {
               return this.var_67.modifyWallItemData(this.var_95,this.var_96,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_67.deleteWallItem(this.var_95,this.var_96,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_590) != 0)
         {
            return false;
         }
         if(this.var_67 != null)
         {
            return this.var_67.initializeRoomObjectInsert(this.var_95,this.var_96,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_67 != null)
         {
            this.var_67.cancelRoomObjectInsert(this.var_95,this.var_96);
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_144;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_850,RoomObjectCategoryEnum.const_260);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_849,RoomObjectCategoryEnum.const_260);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_371,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_349,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1078,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1032,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_298,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_371,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_349,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_900,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_298,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_980) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1008);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_609,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_298,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_35);
      }
      
      public function disposeObjectUser(param1:int, param2:int, param3:int) : void
      {
         this.disposeObject(this.getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_35);
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_739,this.var_95,this.var_96,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_67 != null)
         {
            this.var_67.handleRoomObjectEvent(param1,this.var_95,this.var_96);
         }
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_472 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_41.getRoom(const_543);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_41.createRoom(const_543,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_694.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_500,param8);
               break;
            case RoomObjectCategoryEnum.const_35:
            ...
            case RoomObjectCategoryEnum.const_74:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_178,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_287,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_643,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_748,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_700,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_493,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            this.var_1088.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1080,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_694.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_95,this.var_96,const_309,RoomObjectCategoryEnum.const_74,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_41.getRoom(const_543);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               this.var_694.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1088.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_113);
            if(_loc7_ != null)
            {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_312,param1.image,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1026,param1.adWarningL,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_975,RoomObjectVariableEnum.const_312,param1.clickUrl);
