package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_638:String = "RCL_LOADER_READY";
      
      private static const const_308:String = "RCL_PUBLICROOM_";
      
      private static const const_1512:int = 0;
      
      private static const const_815:int = 1;
      
      private static const name_2:int = 2;
      
      private static const const_383:String = "place_holder";
      
      private static const const_540:String = "wall_place_holder";
      
      private static const const_1146:String = const_383;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_813:String = "tile_cursor";
      
      private static const const_814:String = "selection_arrow";
      ...
      private var var_1225:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         this.var_535 = [];
         this._wallItems = [];
         this.var_2040 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2037 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2041 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2039 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2042 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2038 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_363.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_432.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_432.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            _loc1_ = this.var_362.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_362.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_640.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_538.add(_loc3_,_loc4_);
               if(this.var_535.indexOf(_loc7_) < 0)
               {
                  this.var_535.push(_loc7_);
               }
            }
            ...
            _loc8_ = this.var_537.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_537.remove(_loc7_);
               this.var_537.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2043)
         {
            ...
            {
               this.var_1225.dispatchEvent(new Event(const_638));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_431 != null)
         {
            ...
            this.var_431.add(param1,param2);
         }
         if(this.var_433 != null)
         {
            this.var_433.remove(param2);
            this.var_433.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_431 != null)
         {
            _loc2_ = this.var_431.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_433 != null)
         {
            _loc2_ = this.var_433.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_535.indexOf(param1) >= 0)
         {
      ...
      {
         return [const_383,const_540,ROOM_CONTENT,const_813,const_814];
      }
      ...
      {
         var _loc3_:String = this.var_536.getValue(param1) as String;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_29 || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            if(param1.indexOf("poster") == 0)
            {
               param1 = "poster";
            }
            return int(this.var_537.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2038;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2042 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_29:
                     if(this.var_535.indexOf(_loc4_) == -1)
                     {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_329,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_176 = this.var_1224.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_683,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2040.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1339);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2037.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1224.add(_loc5_,_loc8_);
               this.var_176 = _loc8_;
               this.extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_329,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_522,_loc5_);
         }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_639.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_639.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_432.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_639.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_432.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_432.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_249 && _loc5_ != RoomObjectLogicEnum.const_179)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_413.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_362.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_362.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_362[_loc2_] != null)
         {
            _loc3_ = this.var_362.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_308 + param1) == RoomObjectCategoryEnum.const_74)
         {
            return true;
         }
         return false;
