package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1192:String = "shore";
      ...
      {
         if(this.var_2324 == param1 && this.var_2323 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1192)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_463 + 2;
         var _loc4_:int = this.var_582 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1664 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_376.length)
         {
            if(this.var_376[_loc5_] == true)
            {
               this.var_1664 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_581[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_581[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_463 == 0 || this.var_582 == 0)
         {
            ...
            this.var_463 = _loc2_.getNumber(RoomObjectVariableEnum.const_262);
            this.var_582 = _loc2_.getNumber(RoomObjectVariableEnum.const_314);
         }
         this.var_376 = [];
         this.var_581 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_463 * 2 + this.var_582 * 2)
         {
            this.var_376.push(false);
            this.var_581.push(ShoreMaskCreatorUtility.const_69);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_463 + 2;
         var _loc2_:int = this.var_582 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_63,getSize(param3),this.var_376,this.var_581,assetCollection);
      }
