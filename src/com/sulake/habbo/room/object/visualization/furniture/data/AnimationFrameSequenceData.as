package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_367.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_367.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_367[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_367[_loc3_];
               _loc1_ = 1;
            }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_367.push(this._frames.length - 1);
         this.var_916.push(1);
      }
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         if(this.var_1528)
         {
            param1 = Math.random() * this.var_367.length;
            if(param1 == this.var_367.length)
            {
               param1--;
            }
         }
         param1 = this.var_367[param1 % this.var_367.length];
