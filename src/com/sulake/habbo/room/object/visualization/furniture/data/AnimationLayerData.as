   ...
   public class AnimationLayerData
   {
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_206.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_395 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         var _loc2_:* = null;
         param1 /= this.var_1770;
         var _loc3_:Boolean = false;
         if(!this.var_1528)
         {
            _loc4_ = param1 / this.var_395;
            param1 %= this.var_395;
            if(this._loopCount > 0 && _loc4_ >= this._loopCount || this._loopCount <= 0 && this.var_395 == 1)
            {
               param1 = this.var_395 - 1;
               _loc3_ = true;
            }
            _loc5_ = 0;
            _loc6_ = 0;
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:Boolean, param4:int) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc9_ = this.var_1770 * _loc8_;
            if(param3)
            {
               _loc9_ = 0;
            }
            _loc10_ = false;
            if(!this.var_1528 && !param2.isRandom)
            {
