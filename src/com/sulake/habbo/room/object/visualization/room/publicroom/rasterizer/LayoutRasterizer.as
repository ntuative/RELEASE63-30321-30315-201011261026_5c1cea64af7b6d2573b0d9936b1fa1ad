package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1241:IGraphicAssetCollection;
      
      private var var_1708:XMLList;
      
      private var _offsetX:int;
      
      private var var_1121:int;
      
      private var var_2333:Vector3d;
      
      private var var_849:String;
      
      private var var_35:Map = null;
      ...
      private var var_1070:Point = null;
      
      private var var_1321:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_849)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1321 = this.var_35.getValue(this.var_849);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35 != null)
         {
            ...
            {
               _loc2_ = this.var_35.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_35.add(_loc2_,_loc3_);
         this.var_2333 = new Vector3d(-0.5,0.5,0);
         this.var_848 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2333);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1070.x = _loc3_.x;
         this.var_1070.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_35.getValue(this.var_849);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1665 = RoomObjectVariableEnum.const_1026;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1665 = RoomObjectVariableEnum.const_905;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1071 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1071 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_35.getValue(this.var_849);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2331 && param3 == this.var_2332)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1071 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1071 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1665);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_461;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1321.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1241.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1070.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1070.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_377.indexOf(_loc10_) >= 0 && this.var_848)
            {
               param1 = this.var_377.indexOf(_loc10_);
               if(this.var_584[param1] != "")
               {
                  _loc9_ = this.var_1241.getAsset(this.var_584[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
      ...
      {
         this.var_848 = true;
         var _loc3_:int = this.var_377.indexOf(param1);
         if(_loc3_ < 0)
         {
