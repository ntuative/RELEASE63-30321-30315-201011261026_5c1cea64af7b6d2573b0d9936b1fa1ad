package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      {
         createSprites(this.var_1162 + param1);
      }
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(this.data != null)
         {
            ...
            {
               this.data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + this.var_1162));
               _loc4_++;
            }
            this.data.layoutRasterizer.initializeAds(this.var_1162,this);
         }
         this.var_2502 = true;
      }
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         var _loc6_:String = _loc5_.getString(RoomObjectVariableEnum.const_312);
         var _loc7_:* = !Boolean(_loc5_.getNumber(RoomObjectVariableEnum.const_417));
