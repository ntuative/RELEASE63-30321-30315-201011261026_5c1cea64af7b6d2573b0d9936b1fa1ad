package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_369:PlaneBitmapData = null;
      ...
      private var var_660:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2143 = param10;
         this.var_2141 = param11;
      ...
      {
         return this._isVisible && this.var_660;
      }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_369;
         if(_loc3_ == null)
         {
         ...
         if(this.var_660 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_307))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_256.length * param1.scale;
            _loc6_ = this.var_257.length * param1.scale;
            ...
            if(this.var_813 != null)
            {
               _loc3_ = this.var_813.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1571,this.var_2145,this.var_2143,this.var_2141,this.var_2144,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1423 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_660)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1260.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1260[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_942);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_132.z - originZ,this.var_100.z - originZ,this.var_79.z - originZ,this.var_101.z - originZ);
            if(this._type == const_93)
            {
               relativeDepth += 0.02;
            }
            this.var_1899 = relativeDepth;
            this._isVisible = true;
            this.var_1423 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2142);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_115 || this._type == const_93)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_115 || this._type == const_93))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_812)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_306.length)
            {
               _loc5_ = this.var_306[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(this.var_306.length > this.var_1261.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_812 || this.var_226.length == 0 && this.var_306.length == 0 && !this.var_307 || this.var_695 == null)
         {
            return;
         }
         ...
         if(this.var_307)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_517);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_226.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_63.width - this.var_63.width * _loc3_.leftSideLoc / this.var_256.length;
                  _loc11_ = this.var_63.height - this.var_63.height * _loc3_.rightSideLoc / this.var_257.length;
                  _loc12_ = _loc3_.type;
                  this.var_695.updateMask(this.var_63,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_306.length)
            {
               _loc4_ = this.var_306[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_63.width - this.var_63.width * _loc4_.leftSideLoc / this.var_256.length;
                  _loc11_ = this.var_63.height - this.var_63.height * _loc4_.rightSideLoc / this.var_257.length;
                  _loc13_ = this.var_63.width * _loc4_.leftSideLength / this.var_256.length;
                  _loc14_ = this.var_63.height * _loc4_.rightSideLength / this.var_257.length;
                  this.var_63.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1261.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_307 = false;
