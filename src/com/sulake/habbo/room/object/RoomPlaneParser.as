package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_977:Number = 0.0;
      
      private var var_116:Number = 0.0;
      
      private var var_795:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this._width = param1;
         this._height = param2;
         this.var_438 = this._width;
         this.var_436 = -1;
         this.var_439 = this._height;
         this.var_437 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this._width && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_438 || param1 == this.var_436)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_439;
                  while(_loc6_ < this.var_437)
                  {
               ...
               if(param2 == this.var_439 || param2 == this.var_437)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_438;
                  while(_loc8_ < this.var_436)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(this.var_135);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         this.var_795 = getFloorHeight(this.var_135);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_287,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_977);
         this.addPlane(RoomPlaneData.const_151,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_151,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_116) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_151,Vector3d.sum(param1,Vector3d.product(param3,-this.var_116 / param3.length)),Vector3d.product(param3,(param3.length + this.var_116) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_977 / param2.length);
      ...
      private function extractFloorPlane(param1:Array, param2:Boolean) : Boolean
      {
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_135[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_178,_loc13_,new Vector3d(0,0,-this.var_116),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_116,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_116,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_178,_loc13_,new Vector3d(0,0,-this.var_116),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_116,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_116,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_178,_loc13_,new Vector3d(0,0,-this.var_116),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_116,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_116,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_178,_loc13_,new Vector3d(0,0,-this.var_116),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_116,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_116,param11);
                  }
               }
            }
         }
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_115[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1094;
         }
         var _loc2_:RoomPlaneData = this.var_115[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_115[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
