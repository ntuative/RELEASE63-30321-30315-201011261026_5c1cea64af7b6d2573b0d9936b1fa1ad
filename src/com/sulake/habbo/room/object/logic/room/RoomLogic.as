package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1340:uint = 16777215;
      
      private var var_1687:int = 255;
      
      private var var_1078:uint = 16777215;
      
      private var var_1689:int = 255;
      
      private var var_1079:int = 0;
      
      private var var_1690:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_886,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_583,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_626,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_613,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_624,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1079)
         {
            ...
            if(_loc2_ - this.var_1079 >= this.var_1690)
            {
               _loc3_ = this.var_1078;
               _loc4_ = this.var_1689;
               this.var_1079 = 0;
            }
            else
            {
               _loc7_ = this.var_1340 >> 16 & 255;
               _loc8_ = this.var_1340 >> 8 & 255;
               _loc9_ = this.var_1340 & 255;
               _loc10_ = this.var_1078 >> 16 & 255;
               _loc11_ = this.var_1078 >> 8 & 255;
               _loc12_ = this.var_1078 & 255;
               _loc13_ = (_loc2_ - this.var_1079) / this.var_1690;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1687 + (this.var_1689 - this.var_1687) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_583,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_650:
               param2.setString(RoomObjectVariableEnum.const_643,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_600:
               param2.setString(RoomObjectVariableEnum.const_748,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_802:
               param2.setString(RoomObjectVariableEnum.const_700,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_493:
               ...
               this.var_467.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_609:
               _loc4_ = this.var_467.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_467.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1082:
               param2.setNumber(RoomObjectVariableEnum.const_626,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1021:
               param2.setNumber(RoomObjectVariableEnum.const_613,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_624,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1081,int(param1.bgOnly));
         this.var_1340 = this._color;
         this.var_1687 = this.var_1688;
         this.var_1078 = _loc3_;
         this.var_1689 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_430,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1442,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1407,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1351,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_430,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_151 || _loc13_ == RoomPlaneData.const_287)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
