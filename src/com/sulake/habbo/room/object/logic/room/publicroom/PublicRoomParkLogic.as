package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1118:String = "goawaybus";
      
      private static const const_1117:String = "bus";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1118:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_492,0,_loc4_,_loc5_);
                     break;
                  case const_1117:
                  case const_1116:
