package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_584:int = 70;
      ...
      private var var_1126:uint;
      
      private var var_1382:uint;
      
      private var var_718:int;
      
      private var var_717:Number;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1785 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1785 = 15;
         }
         this.var_1786 = this._window.height;
         this.var_718 = 4;
         this.var_717 = 0;
         this._state = name_1;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_415:
               ...
               _loc2_ = Number(this.var_1125) / Number(this.var_399["time_fade_in"]);
               if(this.var_1125 > int(this.var_399["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_860:
               ...
               if(this.var_1382 > int(this.var_399["time_display"]) && !this.var_1784)
               {
                  this.startFadeOut();
               }
               break;
            case const_861:
               ...
               _loc3_ = 1 - Number(this.var_1126) / Number(this.var_399["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1126 > int(this.var_399["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1785;
         if(this._window.height < this.var_1786)
         {
            this._window.height = this.var_1786;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(this.var_399["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_478;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_478;
            }
         }
         ...
         if(this.var_399["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_718;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_718;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_717;
      }
   }
}
