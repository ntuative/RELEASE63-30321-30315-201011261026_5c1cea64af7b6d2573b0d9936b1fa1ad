package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1150:String = "pixelbalance";
      
      private static const const_1154:String = "badges";
      
      private static const const_1149:String = "selectbadge";
      
      private static const const_1147:String = "inventory";
      
      private static const const_1151:String = "selectfurni";
      
      private static const const_1152:String = "credits";
      
      private static const const_1153:String = "friendlist";
      
      private static const const_1148:String = "pet_inventory";
      ...
      private var var_641:IHabboToolbar;
      ...
      private var var_642:ParkBusDialogManager;
      
      private var var_2044:Boolean;
      
      private var var_788:ClubGiftNotification;
      
      private var var_787:ClubEndingNotification;
      
      private var var_790:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_789);
         }
         var _loc6_:Map = this.var_789["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_641)
         {
            this.var_641.release(new IIDHabboToolbar());
            this.var_641 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_789["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_641 = IHabboToolbar(param2);
         this.var_641.events.addEventListener(HabboToolbarEvent.const_75,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_75)
         {
            ...
            this.var_434 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_789["styles"],this.var_789["view"],this.var_641);
            ...
            registerUpdateReceiver(this.var_434,1);
            registerUpdateReceiver(this,2);
            this.var_363.events.addEventListener(BadgeImageReadyEvent.const_125,this.onBadgeImage);
            this.var_641.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1226[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_363);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1226[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1226[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1354);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_363.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_894);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_894);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1364);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_425.createAvatarImage(param2,AvatarScaleType.const_49);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_363.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc9_ = this.var_363.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_363.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1244,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_993)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1488);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1315)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_787 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_790 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1490 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_434.isSpaceAvailable() && this.var_972.length > 0)
         {
            this.var_434.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1154:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_292);
               }
               break;
            case const_1149:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_434.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_642 == null)
         {
            this.var_642 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_642 != null)
         {
            this.var_642.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_425.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_944,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_425.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2044)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_951);
            this.var_2044 = true;
      ...
      {
         if(param2.type == WindowEvent.const_175 || param2.type == WindowEvent.const_640)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_788 && this.var_788.visible)
         {
            return;
         }
         this.var_788 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_951,_loc6_);
      }
   }
}
