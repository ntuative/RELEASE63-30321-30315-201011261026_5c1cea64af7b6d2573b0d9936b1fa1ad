package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_538:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2003,this.var_399,this._toolbar);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_584 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_538;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_189.length)
         {
            _loc3_ = this.var_189[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_584 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_584 + const_538;
            _loc2_++;
         }
         return _loc1_;
      }
