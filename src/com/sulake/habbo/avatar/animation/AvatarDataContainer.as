package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1946:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_1440 = parseInt(param1.@ink);
         ...
         this.var_1948 = parseInt(_loc3_,16);
         ...
         this.var_1596 = new ColorTransform(this.var_1499,this.var_1501,this.var_1502,this._alphaMultiplier);
         this.var_952 = this.generatePaletteMapForGrayscale(this.var_1948,this.var_1947);
      }
      ...
      {
         return this.var_952.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_952.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_952.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_952.getValue("alphas") as Array;
      }
