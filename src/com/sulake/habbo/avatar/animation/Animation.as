package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1788:DirectionDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1424 = String(param2.@desc);
         }
         else
         {
            this.var_1424 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1383.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         ...
         if(param2.hasOwnProperty("canvas"))
         {
            ...
            {
               this.var_1385.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1788 = new DirectionDataContainer(param2.direction[0]);
         }
         ...
         if(param2.hasOwnProperty("remove"))
         {
            ...
            {
               this.var_1384.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_720.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.const_534)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@const_534;
               this.var_602.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_646,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_602.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_646)
            {
               _loc3_.push(_loc4_.id);
            }
            else if(_loc4_.type == AnimationLayerData.const_523)
            {
               for each(_loc5_ in this.var_720)
               {
      ...
      {
         return this.var_1385 != null;
      }
      
      public function hasDirectionData() : Boolean
      {
         return this.var_1788 != null;
      }
