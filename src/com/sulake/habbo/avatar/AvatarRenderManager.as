package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1789:String = "hd-99999-99999";
      ...
      private var var_643:PaletteManager;
      
      private var var_579:String;
      
      private var var_263:Map;
      
      private var var_193:AvatarAssetDownloadManager;
      
      private var var_1497:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_579 = RenderMode.const_1383;
         ...
         this.var_91.add(AvatarType.const_111,_loc4_);
         ...
         this.var_91.add(AvatarType.const_63,_loc4_);
         ...
         this.var_643 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_91 != null)
         {
            for each(_loc1_ in this.var_91.getValues())
            {
               _loc1_.dispose();
            }
            this.var_91.dispose();
         ...
         if(this.var_193)
         {
            this.var_193.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_295.init();
         this.var_643.init();
         _loc2_ = this.var_91.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_91.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_91.getValue(AvatarType.const_111) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_158.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_193 == null)
               {
                  ...
                  _loc6_ = this.var_158.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_158.getKey("flash.dynamic.avatar.download.url","");
                  this.var_193 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_193.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_772)
         {
            if(this.var_2050 && this.var_2049 && this.var_2051)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_193.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_193.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_91.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_193.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1497)
         {
            this.var_1497 = new AvatarFigureContainer(this.const_1789);
         }
         this.var_193.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1497,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_263 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_263.getKeys())
         {
            _loc4_ = this.var_263.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1451)
         {
            _loc6_ = !this.var_295.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_295.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_91.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_263.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_91.getValue(AvatarType.const_63);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_263.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_263.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_91.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_91.getValue(AvatarType.const_111) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_63:
               _loc3_ = this.var_91.getValue(AvatarType.const_63) as AvatarStructure;
               break;
            default:
