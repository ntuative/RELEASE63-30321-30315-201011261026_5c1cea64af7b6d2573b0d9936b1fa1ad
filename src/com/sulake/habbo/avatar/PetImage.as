package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_498:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            if((this.var_83 == 6 || this.var_83 == 0) && param2 == 7)
            {
               param2 = this.var_83;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1315);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_248.definition.geometryType);
         if(this.var_37 == null || _loc4_ != null && (this.var_37.width != _loc4_.width || this.var_37.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_248.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               if(_loc15_.length > 0)
               {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_83 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_83 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_83 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_83 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc16_.length > 0)
               {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_83 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_83 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_83 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_83 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_285.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_846);
         this.getCache().resetBodyPartCache(this.var_846);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1314 = this._structure.sortActions(this.var_285);
         ...
         {
            this.var_678 = this._structure.getCanvasOffsets(this.var_1314,this._scale,this.var_83);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1314)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_232)
               {
                  this.var_847 = true;
               }
