   ...
   public class CategoryBaseView
   {
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_1836);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_33[this.var_129];
         if(_loc2_ == null)
         {
            return;
         }
