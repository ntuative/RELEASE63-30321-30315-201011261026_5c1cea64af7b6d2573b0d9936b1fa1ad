package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_796 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_.colorTransform(_loc5_.rect,this.var_797.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_796.width,this.var_796.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_796,this.var_796.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_797)
            {
               switch(this.var_797.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_54:
                     _loc4_.style = HabboIconType.const_675;
                     _loc4_.visible = true;
               }
            }
            else
