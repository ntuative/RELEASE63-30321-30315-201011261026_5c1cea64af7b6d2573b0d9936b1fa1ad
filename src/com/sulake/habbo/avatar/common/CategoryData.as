package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1812:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_905 >= 0 && this._parts.length > this.var_905)
         {
            _loc2_ = this._parts[this.var_905];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      {
         return this._parts[this.var_905] as AvatarEditorGridPartItem;
      }
