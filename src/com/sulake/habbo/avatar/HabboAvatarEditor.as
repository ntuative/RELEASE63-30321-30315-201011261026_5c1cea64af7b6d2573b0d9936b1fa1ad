package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1141:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      ...
      private var var_964:AvatarEditorHandler;
      ...
      private var var_777:IFigureData;
      ...
      private var var_1208:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_834 = FigureData.const_73;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_90 != null)
         {
            for each(_loc1_ in this.var_90)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
      ...
      private function init() : void
      {
         ...
         if(!this.var_172)
         {
            ...
            this.var_530["null"] = new FigureData(this);
            this.var_530["null"] = new FigureData(this);
            _loc1_ = this.var_530["null"];
            _loc2_ = this.var_530["null"];
            _loc1_.loadAvatarData(const_1141,FigureData.const_73);
            _loc2_.loadAvatarData(const_1143,FigureData.FEMALE);
            this.var_90 = new Map();
            this.var_426 = new Map();
            this.var_90.add(AvatarEditorFigureCategory.const_615,new BodyModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_44,new HeadModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_257,new TorsoModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_782,new LegsModel(this));
            this.var_90.add(AvatarEditorFigureCategory.const_979,new HotLooksModel(this));
            this.var_426.add(AvatarEditorSideCategory.const_101,new WardrobeModel(this));
            this.var_426.add(AvatarEditorSideCategory.const_456,new ClubPromoModel(this));
            this.var_172 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_963 = param3;
         var _loc4_:FigureData = this.var_530[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_90)
         {
            for each(_loc5_ in this.var_90)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_777.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_777.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_218 == null)
            {
               this.var_218 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_615);
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_90.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_426.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_425 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_777 = this.var_425.getFigureData(AvatarType.const_111);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_964 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_530[this.var_834];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1208 != null)
         {
            ...
            this.var_1208.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1474;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_963 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1142)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1396.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_425.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_425.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1143.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_963 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1143.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_963 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_426.getValue(AvatarEditorSideCategory.const_101);
      }
