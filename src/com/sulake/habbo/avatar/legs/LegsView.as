   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_250,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_199,_windowManager,_assetLibrary);
         }
         else
         {
