   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_160,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_198,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_247,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_231,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_242,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_61 && var_129 == "")
         {
            var_61.switchCategory(FigureData.const_160);
         }
      }
