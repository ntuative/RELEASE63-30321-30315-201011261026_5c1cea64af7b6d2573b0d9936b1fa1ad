   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_201,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_174,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_61,FigureData.const_227,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_61 && var_129 == "")
         {
            var_61.switchCategory(FigureData.const_174);
         }
      }
