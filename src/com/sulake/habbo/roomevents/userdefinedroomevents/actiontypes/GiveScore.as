package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_944:SliderWindowController;
      ...
      {
         return ActionTypeCodes.var_1830;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_944.getValue());
      ...
      {
         this.var_85 = param2;
         this.var_944 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_944.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_944.setValue(1);
         this.var_945 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_945.addEventListener(Event.CHANGE,this.onCounterSliderChange);
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_944.setValue(_loc3_);
         this.var_945.setValue(_loc4_);
      }
