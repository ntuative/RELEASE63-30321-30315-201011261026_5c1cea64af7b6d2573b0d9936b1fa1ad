package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_947:IContainerButtonWindow;
      
      private var var_946:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1427 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_946 = this.var_1427.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_946)
         {
            this.var_946.procedure = this.onButtonClick;
         }
         this.var_947 = this.var_1427.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_947)
         {
            this.var_947.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_214 >= this._localizations.length - 1)
         {
            this.var_947.disable();
         }
         else
         {
            this.var_947.enable();
      ...
      {
         ++this.var_214;
         this.var_214 = Math.min(this.var_214,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_214;
         this.var_214 = Math.max(this.var_214,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_214][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_214][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_214][1]).value;
