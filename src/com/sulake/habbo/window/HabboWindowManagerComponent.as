package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_388:uint = 3;
      ...
      private var var_1735:ProfilerOutput;
      
      private var var_1357:ProfilerAgentTask;
      
      private var var_1358:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_184 = new Array(const_388);
         ...
         this.var_218 = this.var_184[const_1204];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_218.getMouseCursor().defineCustomCursorType(MouseCursorType.const_348,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_218.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1417,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1735)
            {
               this.var_1735 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1735.profiler = _loc3_;
            this.var_1357 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1357);
            this.var_1358 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1358);
            this.var_1101 = true;
         }
      }
      ...
      {
         var _loc3_:Dictionary = this.var_328[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_328[0][param1] as XML : _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_342.length > 0)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1307,new Date().getTime().toString());
