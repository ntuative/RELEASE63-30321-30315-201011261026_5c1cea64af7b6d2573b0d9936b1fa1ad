package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_445 = param1.volume;
         if(this.var_877 != null)
         {
            this.var_877.setValue(this.var_445);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_602));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_445 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1732);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1733);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_445 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1731);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1730);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_702);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_636);
         }
         else
         {
