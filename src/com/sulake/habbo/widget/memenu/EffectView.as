package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_875 != null)
         {
            if(this.var_162.isActive)
            {
               ...
               this.var_875.width = _loc2_ * this.var_483;
            }
            else
            {
               this.var_875.width = 0;
               this.var_179.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_874.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_874.text;
            if(this.var_162.isActive)
            {
               ...
               this.var_874.text = _loc1_;
            }
            else
            {
               this.var_874.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_873 = this._window.findChildByName("effect_hilite");
            this.var_873.visible = false;
         }
         this.var_874 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_875 = this._window.findChildByName("loader_bar");
         if(this.var_875 != null)
         {
            this.var_483 = this.var_875.width;
            this.var_179.start();
            this.onUpdate();
         }
