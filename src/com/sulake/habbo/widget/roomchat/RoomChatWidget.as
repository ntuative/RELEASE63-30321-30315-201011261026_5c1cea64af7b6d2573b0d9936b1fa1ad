package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1207:int = 9;
      
      private static const const_856:int = 10;
      
      private static const const_546:int = 25;
      
      private static const const_1161:int = 25;
      
      private static const const_857:int = 4000;
      
      private static const const_1209:int = 6000;
      
      private static const const_1206:int = 3;
      
      private static const const_1208:int = 1;
      
      private static const const_547:int = 8;
      
      private static const const_390:int = 0;
      
      private static const const_855:int = (const_547 + const_390) * const_102 + const_102;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_34 = param1.createWindow("chat_container","",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_39,new Rectangle(0,0,200,this.var_205 + RoomChatHistoryPulldown.const_79),null,0) as IWindowContainer;
         this.var_34.background = true;
         this.var_34.color = 33554431;
         this.var_34.tags.push("room_widget_chat");
         this.var_329 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1050,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,200,this.var_205),null,0) as IItemListWindow;
         this.var_34.addChild(this.var_329);
         this.var_110 = param1.createWindow("chat_active_content","",HabboWindowType.const_56,HabboWindowStyle.const_39,HabboWindowParam.const_62,new Rectangle(0,0,200,this.var_205),null,0) as IWindowContainer;
         this.var_110.clipping = false;
         this.var_329.addListItem(this.var_110);
         this.var_26 = new RoomChatHistoryViewer(this,param1,this.var_34,param2);
         this.var_2443 = param4.getKey("site.url");
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_847)
         {
            _loc2_ = param1 / const_1161 * const_1206;
            if(_loc2_ + this.var_882 > this.var_881)
            {
               _loc2_ = this.var_881 - this.var_882;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_882 >= this.var_881)
            {
               this.var_881 = const_102;
               this.var_882 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1103 = getTimer() + const_857;
            }
         }
         if(this.var_26 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_603,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_306,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_658,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_605,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_603,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_306,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_658,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_605,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2443);
         _loc2_.define(param1);
         if(this.var_880 != 1)
         {
            _loc2_.senderX /= this.var_880;
         }
         _loc2_.senderX -= this.var_704.x;
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            ...
            {
               this.var_880 = param1.scale / this.var_1738;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_704.x += param1.positionDelta.x / this.var_880;
            this.var_704.y += param1.positionDelta.y / this.var_880;
         }
         if(param1.rect != null)
         {
            if(this.var_26 == null)
            ...
            this.var_34.height = this.var_205 + this.var_26.pulldownBarHeight;
            this.var_329.width = this.var_34.width - this.var_26.scrollbarWidth;
            this.var_329.height = this.var_205;
            this.var_329.x = this.var_34.x;
            this.var_329.y = this.var_34.y;
            this.var_110.width = this.var_34.width - this.var_26.scrollbarWidth;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_65.length > const_1208 || this.historyViewerActive() && this.var_65.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_881 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_65[0]);
            }
            else
            {
               this.var_881 = const_102;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(this._itemList.length > 1)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(this.var_703,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = this.var_703;
               if(_loc1_.aboveLevels > const_547 + const_390 + 2)
               {
                  _loc1_.aboveLevels = const_547 + const_390 + 2;
               }
               this.var_703 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_390 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1209)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_704.x) * this.var_880;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_34.width / 2 - const_856;
         var _loc6_:Number = this.var_34.width / 2 + const_856 - this.var_26.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!this.historyViewerActive() ? 0 : Number(this.var_703);
            if(_loc2_ == this._itemList.length - 1)
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_102 - const_389;
            }
            else
            {
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_205 + this.var_34.y;
      }
      ...
      {
         return "chat_" + this.var_2441.toString() + "_item_" + (this.var_2442++).toString();
      }
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_205 = param1 - this.var_34.y;
         this.var_34.height = this.var_205 + RoomChatHistoryPulldown.const_79;
         if(this.var_26 != null)
         {
            this.var_26.containerResized(this.var_34.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_205 = const_855 + const_389;
         this.var_34.height = this.var_205 + this.var_26.pulldownBarHeight;
         this.var_329.width = this.var_34.width - this.var_26.scrollbarWidth;
         this.var_329.height = this.var_205;
         this.var_110.width = this.var_34.width - this.var_26.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_110.height = this.getTotalContentHeight() + const_389;
         }
         else
         {
            this.var_110.height = this.var_205;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_918)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_855)
         {
            if(_loc1_ <= this.var_205 + this.var_34.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1737 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1737 = false;
         }
