package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_843:int = 150;
      
      private static const const_844:int = 250;
      ...
      private var var_1691:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_34 = param3;
         this.var_2377 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1691 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2372 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1693 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1692 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2376 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2373 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_66 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_291,HabboWindowStyle.const_36,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_79),null,0,0) as IBitmapWrapperWindow;
         this.var_34.addChild(this.var_66);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,this.var_34.height - const_79,param3.width,const_79),null,0) as IWindowContainer;
         this.var_34.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_631,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_79),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_415:
               this.var_66.blend += param1 / const_844;
               this._window.blend += param1 / const_844;
               if(this._window.blend >= 1)
               {
                  this.state = const_322;
               }
               break;
            case const_861:
               this.var_66.blend -= param1 / const_843;
               this._window.blend -= param1 / const_843;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_34.width - this.var_2375;
         }
         if(this.var_66 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2374 == this._window.width)
         {
            return;
         }
         this.var_2374 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2372;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1693;
            _loc2_.disposesBitmap = false;
            this.var_2375 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2377,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1691,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1691,_loc9_);
         ...
         this.var_66.bitmap = this.var_2373;
