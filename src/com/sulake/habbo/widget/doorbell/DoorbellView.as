   ...
   public class DoorbellView
   {
      ...
      public function update() : void
      {
         ...
         if(this.var_50 != null)
         {
            ...
            {
               this.var_50.addListItem(this.createListItem(this.var_325.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      public function createMainWindow() : void
      {
         ...
         this._frame = (this.var_325.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._frame == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         this.var_50 = this._frame.findChildByName("user_list") as IItemListWindow;
         this._frame.visible = false;
