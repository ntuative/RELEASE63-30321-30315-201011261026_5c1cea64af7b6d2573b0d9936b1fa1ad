package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_539:int = 10;
      
      private static const const_852:int = 16;
      
      private static const const_1202:int = 40;
      
      private static const const_1531:int = 5;
      
      private static const const_1201:int = 20;
      ...
      private var var_483:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1094 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2422 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_872 = new Timer(1000,1);
         this.var_872.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_1093 = new Timer(5000,1);
         this.var_1093.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_153,this.windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_46,this.onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_108,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_365,this.onWindowMoved);
         this.var_1720 = true;
         this.var_477 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2423 = _loc2_.width + const_852 + _loc6_.width + const_1201;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1202,_loc8_.width) + const_852);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_483 = param1 - this.var_2423;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_483);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_483);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1094 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_477 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_477.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_477 = _loc2_.text;
            if(!this.var_871)
            {
               this.var_871 = true;
               this.var_872.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_871);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_483)
         {
