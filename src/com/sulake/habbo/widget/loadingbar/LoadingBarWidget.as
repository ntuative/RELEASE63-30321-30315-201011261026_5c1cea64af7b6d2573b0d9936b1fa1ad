package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_447.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_447 = null;
         }
         if(this.var_37 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_97,this.onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_97,this.onShowLoadingBar);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_265,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_97,this.onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_97,this.onShowLoadingBar);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_265,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_447 == null)
         {
            this.var_447 = new Sprite();
            this.var_447.addChild(new Bitmap(this.var_37));
            this.var_447.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_447.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_37;
            }
         }
         _loc2_.setDisplayObject(this.var_447);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1163 != "")
         {
            HabboWebTools.openWebPage(this.var_1163);
         }
      }
   }
}
