package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1775:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_349 = new Timer(this.const_1775);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = this.var_941.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            this.updateCommandButtonsViewState(new Array());
            this.requestEnabledCommands(this.var_516);
         }
         else
         {
      ...
      {
         var _loc2_:Array = this.var_941.getValue(this.var_516) as Array;
      ...
      {
         this.var_941.remove(param1);
         this.var_941.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_787,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_46,this.onWindowDesktopResized);
      ...
      private function updateCommandButtonsViewState(param1:Array) : void
      {
         ...
         do
         {
            ...
            _loc2_ = this.var_40.findChildByName(_loc4_) as IButtonWindow;
            if(_loc2_ == null)
            {
               break;
            }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_350,this.var_516));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_570,this.var_516,this.var_1894 + " " + _loc6_);
