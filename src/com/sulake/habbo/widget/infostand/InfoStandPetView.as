package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_209:IBorderWindow;
      ...
      private const const_1781:int = 16;
      
      private const const_1782:uint = 11184810;
      
      private const const_1786:uint = 6710886;
      
      private const const_1788:uint = 3355443;
      
      private const const_1783:String = "level";
      
      private const const_1780:String = "experience";
      
      private const const_1787:String = "energy";
      
      private const const_1784:String = "nutrition";
      ...
      {
         if(this.var_49 == null || this.var_209 == null || this.var_62 == null)
         {
            return;
         }
         ...
         this.var_209.height = this.var_49.height + 20;
         this._window.width = Math.max(this.var_209.width,this.var_62.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_209.width < this.var_62.width)
         {
            this.var_209.x = this._window.width - this.var_209.width;
            this.var_62.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1783,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1780,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1787,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1784,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_516 = param1.id;
         this.var_1229.remove(param1.id);
         this.var_1229.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1785,this.const_1781,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1782);
         ...
         _loc5_.fillRect(_loc7_,this.const_1786);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1229.getValue(this.var_516) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_209 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_209 != null)
         {
            this.var_49 = this.var_209.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_209.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_177 && this.var_177.getPetId() == this.var_516)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_406,this._widget.petData.ownerId);
