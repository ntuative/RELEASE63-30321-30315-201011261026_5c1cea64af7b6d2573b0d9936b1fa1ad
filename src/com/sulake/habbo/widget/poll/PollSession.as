package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1080:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_236 = new PollOfferDialog(this._id,param1,this.var_1080);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_236 = new PollContentDialog(this._id,param1,param3,this.var_1080);
      }
      ...
      {
         this.var_1080.windowManager.alert("${poll_thanks_title}",this.var_1452,0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
