package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1264:Array = null;
      
      private var var_1061:Array = null;
      
      private var var_1634:int = -1;
      
      private var var_1301:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1301 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_123,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_135,this.showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_317,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_123,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_135,this.showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_317,this.update);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(this.var_50.scrollableRegion.height - this.var_50.height,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         this.var_50 = this._window.findChildByName("choices") as IItemListWindow;
         if(this.var_50 == null)
         {
            return false;
         }
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         if(this._window == null || this.var_50 == null)
         {
            return;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_50.numListItems)
         {
            _loc2_ = this.var_50.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
            if(_loc4_ != this.var_1634)
            {
               _loc2_.blend = 0.5;
            }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(param1) / this.var_1301;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1301 - param1) / 1000,0);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2212;
         if(_loc2_ > this.var_1301)
         {
            this.vote();
            return;
         }
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_50.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_50.numListItems)
         {
            _loc4_ = this.var_50.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
