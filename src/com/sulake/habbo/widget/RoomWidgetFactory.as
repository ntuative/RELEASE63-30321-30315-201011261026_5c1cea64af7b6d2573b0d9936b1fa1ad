package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2616:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2616 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_375:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this._localizations,this.var_113,this.var_2120++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this._localizations,this);
               break;
            case RoomWidgetEnum.const_468:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this._localizations,this.var_113,this._catalog);
               break;
            case RoomWidgetEnum.const_424:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this._localizations,events,this.var_113);
               break;
            ...
            case RoomWidgetEnum.const_392:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this._localizations,this.var_113);
               break;
            case RoomWidgetEnum.const_726:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this._localizations,this.var_113);
               break;
            case RoomWidgetEnum.const_138:
               _loc2_ = new VoteWidget(this._windowManager,assets,this._localizations,this.var_113);
               break;
