package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1051:Function;
      
      private var var_1050:Function;
      
      private var var_677:IAssetLibrary;
      
      private var var_1052:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_677.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_31,this.hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_45,this.hotelViewLoadedHandler);
         }
         else
         {
            this.var_1050 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_31,this.hotelViewLoadedCallbackHandler);
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_677.getAssetByName(_loc2_.assetName);
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_31,this.hotelViewLoadedHandler);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_31)
         {
            ...
            {
               this.var_1050(_loc4_);
               this.var_1050 = null;
            }
         }
         _loc2_.removeEventListener(AssetLoaderEvent.const_31,this.hotelViewLoadedCallbackHandler);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_677.loadAssetFromFile("hotel_view_banner_" + this.var_1052,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_31,this.bannerLoadedHandler);
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_614));
            }
            this.var_1051 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_31,this.bannerLoadedCallbackHandler);
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_31,this.bannerLoadedHandler);
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_31,this.bannerLoadedCallbackHandler);
