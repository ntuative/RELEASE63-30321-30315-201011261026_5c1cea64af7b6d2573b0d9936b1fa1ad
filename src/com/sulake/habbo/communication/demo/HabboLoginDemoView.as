package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_477:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_167.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_128,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         {
            dispatchEvent(new Event(const_477));
         }
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            this.var_166.removeEventListener(SSOTicket.const_370,this.onParsedTicketSuccess);
            this.var_166.removeEventListener(SSOTicket.const_300,this.onParsedTicketFailure);
            this.var_166 = null;
         }
         var _loc1_:String = "";
         if(this.var_167.habboConfiguration != null)
         {
            _loc1_ = this.var_167.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = this.var_167.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_166 = new SSOTicket(this.var_167.assets,_loc2_,_loc1_);
         this.var_166.addEventListener(SSOTicket.const_370,this.onParsedTicketSuccess);
         this.var_166.addEventListener(SSOTicket.const_300,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_166.ticket);
         this.var_167.shockwaveClientUrl = this.var_166.shockwaveClientUrl;
         this.var_167.ssoTicket = this.var_166.ticket;
         this.var_166.removeEventListener(SSOTicket.const_370,this.onParsedTicketSuccess);
         this.var_166.removeEventListener(SSOTicket.const_300,this.onParsedTicketFailure);
         this.var_166 = null;
         dispatchEvent(new Event(const_477));
