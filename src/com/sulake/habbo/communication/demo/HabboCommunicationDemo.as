package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_415:IKeyExchange;
      
      private var var_761:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_1911:PseudoRandom;
      
      private var var_518:String;
      ...
      private var var_186:HabboHotelView;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_518 = param1;
            this.var_44.initConnection(HabboConnectionType.const_233);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_19.events.addEventListener(RoomSessionEvent.const_94,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_44 && this.var_113 && this.var_19 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_186 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_113.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_113.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_186.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_113.getKey("use.sso.ticket") == "1";
         this.var_518 = this.var_113.getKey("sso.ticket",null);
         this.var_1426 = this.var_113.getKey("flash.client.url","");
         this.var_1909 = this.var_113.getKey("external.variables.txt","");
         if(this.var_186 == null)
         {
            this.var_186 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_44.mode = HabboConnectionType.const_116;
            if(this.var_518)
            {
               this.var_44.initConnection(HabboConnectionType.const_233);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_477,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_44.mode = HabboConnectionType.const_1029;
            }
         }
         this.var_44.initConnection(HabboConnectionType.const_233);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_655);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_1911 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_44.mode)
         {
            case HabboConnectionType.const_116:
               _loc6_ = "";
               _loc6_ = this.var_113.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_113.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1178 = _loc4_;
               this.var_186.loadBannerImage(_loc7_ + "?token=" + this.var_1178,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1029:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1304:
               this.var_761 = this.generateRandomHexString(30);
               this.var_415 = new DiffieHellman(new BigInteger(this.var_113.getKey("connection.development.prime"),16),new BigInteger(this.var_113.getKey("connection.development.generator"),16));
               this.var_415.init(this.var_761);
               _loc8_ = this.var_415.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_415.method_9(_loc4_,10);
         var _loc5_:String = this.var_415.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_1911);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1426,this.var_1909));
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_518 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_518);
            _loc2_.send(_loc4_);
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_206);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1179)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_165);
         }
         if(param1.type == Event.CLOSE && !this.var_1910)
         {
            _loc2_ = this.var_113.getKey("logout.disconnect.url");
            if(this.var_113.keyExists("facebook.user"))
            {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_1910 = true;
         var _loc2_:String = this.var_113.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_113.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1178);
         ...
         this.var_415 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_415.init(_loc14_);
            _loc15_ = this.var_415.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_761 = _loc14_;
            }
