package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_848:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_1422:IEncryption;
      
      private var var_1893:PseudoRandom;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(this.var_1422 != null)
         {
            ...
            _loc6_ = this.var_1893.nextInt() % 5;
            ...
            _loc5_ = this.var_1422.encipher(_loc7_,true);
