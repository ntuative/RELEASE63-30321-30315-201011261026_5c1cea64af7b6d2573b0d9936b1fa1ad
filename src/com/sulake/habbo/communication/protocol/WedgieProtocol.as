package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1251:uint = 1;
      
      public static const const_1320:uint = 2;
       
      
      private var var_1351:IProtocolEncoder;
      
      private var var_981:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1351 = new WedgieEncoder();
         this.var_981 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1251)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_981.getID(_loc4_);
