package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      {
         this.var_345 = param1.status;
         this._type = param1.type;
         this.var_1724 = param1.roomItemTypeName;
         this.var_1726 = param1.rewardCurrencyAmount;
         this.var_1796 = new Date();
         this.var_1796.setTime(param1.endDateTimeStamp);
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_182)
            {
               this.var_822.style = this.var_2531;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_182)
            {
               this.var_822.style = this.var_2532;
            }
         }
      }
