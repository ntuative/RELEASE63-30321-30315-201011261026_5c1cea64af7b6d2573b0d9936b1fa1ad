package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_195:IFrameWindow;
      ...
      private function onQuestCompletedRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_195.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
      ...
      {
         this.var_195 = IFrameWindow(this.var_68.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         this.var_195.findChildByTag("close").procedure = this.onCompletedDialogClose;
         this.var_195.center();
         var _loc2_:IWindow = this.var_195.findChildByName("button.catalog");
         if(_loc2_)
         {
         ...
         this.var_195.caption = "${quest.completed}";
         this.var_195.findChildByName("reward.description").caption = "${" + _loc3_ + ".completed.reward}";
         ...
         this.var_195.findChildByName("description").caption = this.var_68.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_195.findChildByName("reward.currency.desc").caption = this.var_68.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
         var _loc5_:String = "icon_" + this.var_68.id + "_reward_" + param1.rewardCurrencyAmount;
         var _loc6_:IBitmapWrapperWindow = this.var_195.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
