package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine
   {
      ...
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1418,true);
      }
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_158.getKey("image.library.questing.url");
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_31,param2);
      }
