package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_111:Quest;
      
      private var _view:IWindow;
      
      private var var_1756:int;
      
      private var var_2467:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_111.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_2467 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
                  throw new Error("[QuestView] Could not create view for quest type: " + this.var_111.type + " !");
               }
               return;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_111.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_111)
         {
            this.var_68.controller.activateQuest(this.var_111);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_68.id,this.var_111.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_68.id,"type_" + this.var_111.type.toLowerCase()].join(".");
         ...
         if(this.var_111.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc32_ = this.var_68.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_111.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_68.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1756 = _loc33_.id;
         ...
         else if(this.var_111.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
         ...
         switch(this.var_111.status)
         {
            case QuestStatusEnum.const_420:
            ...
            case QuestStatusEnum.const_177:
               ...
               _loc18_ = 4290822336;
               break;
            case QuestStatusEnum.const_565:
         ...
         this.var_68.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_111.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_);
         var _loc19_:int = this.var_111.endDate.date;
         var _loc20_:int = this.var_111.endDate.month + 1;
         var _loc21_:int = this.var_111.endDate.fullYear;
         var _loc22_:int = this.var_111.endDate.minutes;
         var _loc23_:int = this.var_111.endDate.hours;
         ...
         var _loc31_:String = "icon_" + this.var_68.id + "_reward_" + this.var_111.rewardCurrencyAmount;
