package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_990 = IWindowContainer(this.var_46.getXmlWindow("chatlog_roomheader"));
         this.var_991 = IWindowContainer(this.var_46.getXmlWindow("chatlog_chatline"));
         ...
         this.var_50 = IItemListWindow(this._frame.findChildByName("chatline_list"));
         this._frame.procedure = this.onWindow;
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_46.connection.send(this.var_1479);
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         this.var_50.addListItem(_loc2_);
         var _loc4_:* = true;
         for each(_loc5_ in param1.chatlog)
         {
            this.populateChatline(this.var_50,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_991.clone());
         _loc4_.color = this.var_1542[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
      ...
      private function refreshListDims() : void
      {
         ...
         {
            _loc2_ = IWindowContainer(this.var_50.getListItemAt(_loc1_));
