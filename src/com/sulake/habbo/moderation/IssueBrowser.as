package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1809:String = "my_issues";
      
      private const const_1810:String = "open_issues";
      
      private const const_1808:String = "picked_issues";
      
      private const const_1813:String = "closed_issues";
      ...
      private var var_1808:IIssueBrowserView;
      
      private var var_1807:IIssueBrowserView;
      
      private var var_1809:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_338.view.width = this.var_246.container.width;
         this.var_338.view.height = this.var_246.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1809:
               ...
               {
                  this.var_1808 = new MyIssuesView(this.issueManager,this,this.var_246.container);
               }
               return this.var_1808;
            case this.const_1810:
               if(this.var_1807 == null)
               {
                  this.var_1807 = new OpenIssuesView(this.issueManager,this,this.var_246.container);
               }
               return this.var_1807;
            case this.const_1808:
               if(this.var_1809 == null)
               {
                  this.var_1809 = new PickedIssuesView(this.issueManager,this,this.var_246.container);
               }
