package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_2053 = IWindowContainer(this.var_46.getXmlWindow("roomvisits_row"));
         ...
         this.var_50 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1433;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_2053.clone());
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_50.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_50.scrollableRegion.height > this.var_50.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_50.width += 17;
            }
         }
         else if(_loc4_)
         {
