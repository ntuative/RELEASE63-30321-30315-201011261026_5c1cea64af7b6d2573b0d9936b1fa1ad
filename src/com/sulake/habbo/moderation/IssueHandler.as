package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_457:UserInfoCtrl;
      
      private var var_1049:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(this.var_58.windowManager == null || this.var_58.assets == null)
         {
            return;
         }
         var _loc1_:XmlAsset = this.var_58.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         this._window = this.var_58.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         this.var_58.disableButton(this.var_58.initMsg.chatlogsPermission,this._window,"show_chatlog");
         ...
         this.var_457 = new UserInfoCtrl(this._window,this.var_58,_loc3_.message);
         this.var_1049 = new UserInfoCtrl(this._window,this.var_58,_loc3_.message);
         this.var_457.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_118.getHighestPriorityIssue().reporterUserId);
         ...
         {
            this.var_1049.load(_loc4_,this.var_118.reportedUserId);
         }
         else
         {
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = this.var_58.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = this.var_58.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = this.var_58.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = this.var_58.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_58 != null && this.var_58.issueManager != null && this.var_118 != null)
         {
            this.var_58.issueManager.removeHandler(this.var_118.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.closeBundle(this.var_118.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.closeBundle(this.var_118.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.closeBundle(this.var_118.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.issueManager.releaseBundle(this.var_118.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_58.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_58,WindowTracker.const_1028,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_457 = new UserInfoCtrl(this._window,this.var_58,_loc3_.message);
            this.var_457.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      {
         if(this._window == null || this.var_58 == null || this.var_58.issueManager == null)
         {
            return;
         }
         ...
         {
            this.var_58.issueManager.autoPick();
         }
      }
   }
}
