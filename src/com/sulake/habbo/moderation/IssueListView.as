package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1471 = this.var_578.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         this.var_50.destroyListItems();
         this.var_50.invalidate();
         if(param1 == null)
         {
            return;
         }
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || this.var_1471 == null)
            {
               return;
            }
            _loc2_ = this.var_1471.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = this.var_50.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = this.var_578.assets.getAssetByName(_loc8_) as BitmapDataAsset;
