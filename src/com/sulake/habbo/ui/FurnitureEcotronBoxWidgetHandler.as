package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_729,RoomWidgetEcotronBoxOpenMessage.const_760,RoomWidgetEcotronBoxOpenedMessage.const_1322];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_729:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_760:
