   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_750,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_446,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_750,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_927,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_947,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_446,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1233)
            {
               ...
               this.var_1233 = _loc3_;
               this.var_1514 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1514;
            }
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_585);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_713);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_606);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_623);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_718);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_789);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_716);
         _loc1_.push(RoomWidgetStopEffectMessage.const_637);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1260);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1036);
         _loc1_.push(RoomWidgetToolbarMessage.const_776);
         _loc1_.push(RoomWidgetToolbarMessage.const_592);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_358);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1242);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_992);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_737);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_743);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_602);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1302);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_636);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_724);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_619);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_353);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_743:
            ...
            case RoomWidgetWaveMessage.const_564:
               ...
               break;
            case RoomWidgetDanceMessage.const_585:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_713:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_606:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_623:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_716:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1057)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_184,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_789:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_973:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_946:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1258:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1482:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_637:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1084:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1036:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_737:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_776:
               ...
               break;
            case RoomWidgetToolbarMessage.const_592:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_509,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_358:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_455));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_602:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_636:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_688));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_446:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_421));
         }
      }
