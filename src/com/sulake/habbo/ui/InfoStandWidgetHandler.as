package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_737.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_737.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_777);
         _loc1_.push(RoomWidgetUserActionMessage.const_682);
         _loc1_.push(RoomWidgetUserActionMessage.const_620);
         _loc1_.push(RoomWidgetUserActionMessage.const_758);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_800);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_756);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_595);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_572);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1370);
         _loc1_.push(RoomWidgetPetCommandMessage.const_570);
         _loc1_.push(RoomWidgetPetCommandMessage.const_787);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_428)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_350 || param1.type == RoomWidgetUserActionMessage.const_517 || param1.type == RoomWidgetUserActionMessage.const_419)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_777:
            ...
            case RoomWidgetUserActionMessage.const_620:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1039,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_758:
            ...
            case RoomWidgetUserActionMessage.const_611:
               ...
               break;
            case RoomWidgetUserActionMessage.const_800:
            ...
            case RoomWidgetFurniActionMessage.const_307:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_756:
            ...
            case RoomWidgetUserActionMessage.const_350:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_595:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_572:
            ...
            case RoomWidgetUserActionMessage.const_735:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_787:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_371);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1032);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_228)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_881)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_448);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_202)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_245)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_711);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1414;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_990;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1062;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1386);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_737.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_49);
            this.var_737.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = this._container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_35);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_711);
