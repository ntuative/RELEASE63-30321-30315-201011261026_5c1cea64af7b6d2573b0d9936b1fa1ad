package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1794:String = "room_widget";
      
      private var var_52:IWindowContainer;
      
      private var var_657:int = 50;
      
      private var var_2617:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < this.var_52.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_289,this.trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(this.const_1794) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_52.getChildByTag(this.const_1165) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_657;
               _loc2_.width = this.var_52.desktop.width - this.var_657;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_657;
               _loc2_.height = this.var_52.desktop.height - this.var_657;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_52.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_52.findChildByTag(this.const_1165) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
