package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_975:IHabboHelp;
      ...
      {
         this.var_1231 = RoomDesktop.const_425;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_589.release(new IIDHabboSoundManager());
            this.var_589 = null;
         }
         ...
         {
            this.var_425.release(new IIDAvatarRenderManager());
            this.var_425 = null;
         }
         ...
         {
            this.var_975.release(new IIDHabboHelp());
            this.var_975 = null;
         }
         ...
         {
            this.var_791.release(new IIDHabboModeration());
            this.var_791 = null;
         }
         ...
         {
            this.var_363.release(new IIDSessionDataManager());
            this.var_363 = null;
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_425 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_265.events.addEventListener(AdEvent.const_484,this.adEventHandler);
            this.var_265.events.addEventListener(AdEvent.const_502,this.adEventHandler);
            this.var_265.events.addEventListener(AdEvent.const_411,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_975 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_791 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_791);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_589 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_19)
         {
            ...
            this.var_19.events.addEventListener(RoomSessionEvent.const_82,this.roomSessionStateEventHandler);
            this.var_19.events.addEventListener(RoomSessionEvent.const_94,this.roomSessionStateEventHandler);
            this.var_19.events.addEventListener(RoomSessionChatEvent.const_176,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionChatEvent.const_435,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionUserBadgesEvent.const_126,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDoorbellEvent.const_103,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDoorbellEvent.const_140,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDoorbellEvent.const_43,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPresentEvent.const_288,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_256,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_252,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_693,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_996,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_957,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_210,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_200,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_255,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_221,this.roomSessionDialogEventHandler);
            ...
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_254,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_561,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_766,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_173,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_745,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_589,this.roomSessionDialogEventHandler);
            this.var_19.events.addEventListener(RoomSessionQueueEvent.const_528,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionVoteEvent.const_123,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionVoteEvent.const_135,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPollEvent.const_129,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPollEvent.const_68,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionPollEvent.const_121,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionDimmerPresetsEvent.const_396,this.roomSessionEventHandler);
            this.var_19.events.addEventListener(RoomSessionFriendRequestEvent.const_137,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_561:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_766:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_754,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_676,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_558,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_443,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_432,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_59,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_568,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_298,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_739,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_209,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_738,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_432 || param1.type == RoomEngineEvent.const_443)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_676:
               _loc5_ = false;
               ...
               if(this.var_1231 != RoomDesktop.const_425)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_279,this.var_1231);
               }
               if(this.var_265 != null)
               {
            ...
            case RoomEngineEvent.const_558:
               ...
               break;
            case RoomEngineRoomColorEvent.const_568:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.sessionDataManager = this.var_363;
         _loc3_.roomSessionManager = this.var_19;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_425;
         ...
         _loc3_.habboHelp = this.var_975;
         _loc3_.moderation = this.var_791;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_589;
