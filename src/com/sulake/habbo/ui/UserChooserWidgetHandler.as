package com.sulake.habbo.ui
{
   ...
   public class UserChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleUserChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc5_:int = this._container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_35);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc4_ = this._container.roomEngine.getRoomObjectWithIndex(_loc1_,_loc2_,_loc6_,RoomObjectCategoryEnum.const_35);
         ...
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_678,_loc3_));
      }
