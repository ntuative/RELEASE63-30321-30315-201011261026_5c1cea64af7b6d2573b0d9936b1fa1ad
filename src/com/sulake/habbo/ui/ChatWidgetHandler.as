   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_401 != null)
         {
            ...
            {
               _loc2_ = this.var_401.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_402 != null)
         {
            ...
            {
               _loc2_ = this.var_402.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_593,RoomWidgetChatSelectAvatarMessage.const_604];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_593:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_604:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_176:
               ...
               if(_loc3_ != null)
               {
                  _loc4_ = this._container.roomEngine.getRoomObject(_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.userId,RoomObjectCategoryEnum.const_35);
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_402.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_401.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_908.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_228)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_402.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_401.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_908.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
                        ...
                        _loc14_ = "null";
                        _loc2_ = new RoomWidgetChatUpdateEvent(_loc14_,_loc3_.userId,_loc3_.text,_loc11_,RoomObjectCategoryEnum.const_35,_loc6_,_loc7_,_loc13_,_loc12_,_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.chatType,_loc3_.links);
                     }
                  }
               }
         }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1135 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1135);
            }
            if(this.var_735 == null)
            {
               ...
               this.var_494.y = 0;
               this.var_494.z = 0;
               this.var_735 = _loc4_.getScreenPoint(this.var_494);
               this.var_1135 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_494.x = 0;
            this.var_494.y = 0;
            this.var_494.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_494);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_735.x || _loc8_.y != this.var_735.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_735,_loc5_));
