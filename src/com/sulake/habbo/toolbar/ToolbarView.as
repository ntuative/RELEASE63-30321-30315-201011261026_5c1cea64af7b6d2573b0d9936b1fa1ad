package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_441:String = "LEFT";
      
      private var var_136:Number = 50;
      
      private var var_979:Boolean = true;
      
      private var var_980:Number = 1;
      
      private var var_1235:Number = 0;
      
      private var var_1524:Number = 15;
      
      private var var_1523:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2612 = new Array();
         ...
         this.var_136 = this._window.width;
         this.var_196 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_56,HabboWindowStyle.const_986,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_979 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_979)
         {
         ...
         this.var_980 = _loc6_.toolbar.@margin_top;
         this.var_1235 = _loc6_.toolbar.@margin_bottom;
         this.var_1524 = _loc6_.toolbar.@min_group_margin;
         this.var_1523 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_222,param1,param2,this._window,this.var_261);
         this.createGroupsFromXmlList(_loc8_,this.var_542,param1,param2,this.var_196,this.var_261);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_136);
      ...
      public function dispose() : void
      {
         ...
         while(this.var_542.length > 0)
         {
            _loc1_ = this.var_542.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_136,this.var_441,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_441);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_136,this.var_441);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_136,this.var_441);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_542.length)
         {
            _loc2_ = this.var_542[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_196 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_196.x = this.var_136 + this.var_1523;
               this.var_196.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_136;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_136;
               this._window.y = 0;
               this.var_196.x = 0;
               this.var_196.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_136;
               this._window.x = 0;
               this._window.y = 0;
               this.var_196.x = 0;
               this.var_196.y = this.var_136 + this.var_1523;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_136;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_136;
               this.var_196.x = 0;
               this.var_196.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1235;
         _loc4_ -= this.var_980;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_980;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_222.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1524,(this._window.height - _loc5_ * _loc8_ - this.var_980 - this.var_1235) / (this.var_222.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1524,(this._window.width - _loc5_ * _loc8_ - this.var_980 - this.var_1235) / (this.var_222.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_222.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_441;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_542.length)
         {
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_136)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_136)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_136)
         {
            return "BOTTOM";
         }
         return null;
