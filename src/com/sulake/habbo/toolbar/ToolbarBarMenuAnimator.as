package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1161:Number = 25;
      
      private static const const_1206:Number = 90;
      
      private static const const_823:int = 50;
      
      private static const const_1162:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1255:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_656 = new Timer(const_1161);
         this.var_656.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_302[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_823 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_823 || param1.desktop.height - param1.y < const_1162;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1255.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_302.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1255.getIconLoc(param1.iconId);
      ...
      {
         return this.var_556[this.var_555.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_555[this.var_556.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            this.var_556.splice(_loc3_,1);
         }
         this.var_556.push(param1.name);
         this.var_555.push(param2);
         param1.addEventListener(WindowEvent.const_365,this.windowEventListener);
      ...
      {
         if(this.var_302.indexOf(param1) > -1)
         {
            if(const_189)
            {
            ...
            else
            {
               ...
               this.var_302.splice(this.var_302.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_556.length)
         {
            if(this.var_556[_loc2_] == param1.window.name)
            {
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_302.length)
         {
            _loc2_ = this._itemList[this.var_302[_loc7_]];
            if(_loc2_.active)
            {
