package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_531:ToolbarBarMenuAnimator;
      ...
      private var var_2013:int = 5;
      
      private var var_2025:int;
      
      private var var_136:Number;
      
      private var var_2024:XML;
      ...
      {
         return this.var_1218.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2024.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_636.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_636.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1220.length)
         {
            _loc2_ = this.var_636.indexOf(this.var_1220[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_262[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_958 + _loc3_);
                  _loc3_ += this.var_1219;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_262[this.var_636.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_531);
         this.var_34.addChild(_loc2_.window);
         this.var_636.push(param1);
