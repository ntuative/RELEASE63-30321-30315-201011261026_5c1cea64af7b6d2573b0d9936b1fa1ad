   ...
   public class InventoryMainView
   {
      ...
      public function dispose() : void
      {
         ...
         if(this._toolbar)
         {
            ...
            {
               this._toolbar.events.removeEventListener(HabboToolbarEvent.const_75,this.onHabboToolbarEvent);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this._toolbar != null && this.var_1087)
         {
         ...
         this._controller.inventoryViewOpened(this.var_692);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_692);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1709);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_693 == InventoryCategory.const_156)
            {
               this.toggleCategoryView(InventoryCategory.const_156);
            }
            else if(this.var_693 == InventoryCategory.const_77)
            {
