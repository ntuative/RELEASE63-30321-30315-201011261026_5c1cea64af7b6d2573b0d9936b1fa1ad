package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_618:BitmapData;
      
      protected var var_2118:int;
      
      protected var var_1405:Boolean;
      
      protected var var_1874:Boolean;
      
      protected var var_2598:BitmapData;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_1874 = param7;
         this._items = new Map();
         this._mainCategory = param2;
         this._category = param3;
         this.var_1856 = param8;
         this.var_1657 = param9;
         if(param10 != null)
         {
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1657));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1856);
         }
         if(_loc1_.id > 0)
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_703)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(this.var_1874 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2598;
               _loc5_.visible = true;
            }
            else
            {
