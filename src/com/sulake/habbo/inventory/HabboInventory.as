package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_959:IRoomSession;
      ...
      private const const_1790:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_19 != null)
         {
            this.var_19.events.removeEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
            this.var_19.events.removeEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
            this.var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_442,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_45.getValue(InventoryCategory.const_77));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_45.getValue(InventorySubCategory.const_280));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_45.getValue(InventoryCategory.const_691));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_45.getValue(InventoryCategory.const_292));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_45.getValue(InventoryCategory.const_344));
      }
      ...
      {
         return PetsModel(this.var_45.getValue(InventoryCategory.const_156));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_45.getValue(InventoryCategory.const_318) as MarketplaceModel;
      }
      ...
      {
         this.var_363 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_19.events.addEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
         this.var_19.events.addEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
         this.var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_442,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_363 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_19 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_45.add(InventoryCategory.const_318,_loc1_);
         ...
         this.var_45.add(InventoryCategory.const_77,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_363);
         this.var_45.add(InventoryCategory.const_292,_loc3_);
         ...
         this.var_45.add(InventoryCategory.const_691,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_363);
         this.var_45.add(InventoryCategory.const_344,_loc5_);
         ...
         this.var_45.add(InventorySubCategory.const_280,_loc6_);
         ...
         this.var_45.add(InventoryCategory.const_156,_loc8_);
         this.var_172 = true;
         if(this.var_2091)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_798.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_798.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_798.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_798.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1790);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_927));
      }
