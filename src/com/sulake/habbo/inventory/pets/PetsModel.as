package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(this.var_993.add(param1.id,param1))
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1544 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_35,RoomObjectTypeEnum.const_228,_loc3_.figure);
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_993)
         {
            if(_loc2_.id == param1)
            {
               return _loc2_;
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1544 && param1.type == RoomEngineObjectEvent.const_209)
         {
