package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_48.updateItemList(this.var_684);
         this.var_48.updateItemList(this.var_1322);
      ...
      public function close() : void
      {
         if(this.var_700)
         {
            if(this._state != const_162 && this._state != const_219)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_162;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_938);
            this.var_700 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_683 + " OTHER: " + this.var_1072);
         ...
         {
            case const_162:
               if(param1 == const_171 || param1 == const_219)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_48.alertPopup(TradingView.const_1001);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_684)
            {
               this.var_683 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1072 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_684)
            {
               this.var_48.alertPopup(TradingView.const_1048);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_275.length < const_1262)
         {
