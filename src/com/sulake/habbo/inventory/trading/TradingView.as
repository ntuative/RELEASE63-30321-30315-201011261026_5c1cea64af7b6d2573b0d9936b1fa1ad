package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_827:uint = 4284532064;
      
      private static const const_826:uint = 2577770;
      ...
      private var var_373:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_373 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1588 = this.createMinimizedWindow();
         }
         if(!this.var_2202)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_827) : uint(const_826);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_827) : uint(const_826);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_879)
            {
            ...
            this.var_373.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_464);
            this.var_373.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_373.hideDelayed();
         }
      }
