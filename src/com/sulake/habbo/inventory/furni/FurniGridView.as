package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_462 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_462.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_462.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_61.toggleItemSelection(this._category,this.var_462.getGridItemIndex(param1.window));
            this.var_580 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_580 != null && this.var_580 == param2 && !this.var_61.isTradingOpen)
         {
