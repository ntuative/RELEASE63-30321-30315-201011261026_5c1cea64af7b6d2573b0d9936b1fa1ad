package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1811:int = 0;
      
      private const const_815:int = 1;
      
      private const const_1537:int = 2;
      
      private const const_1538:int = 3;
      
      private const const_1539:int = 42;
      
      private const const_1540:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_490.add(FurniModel.const_42,new FurniGridView(this.var_61,FurniModel.const_42,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_490.add(FurniModel.const_47,new FurniGridView(this.var_61,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_490.getValue(this.var_398);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_61.getCategoryContent(this.var_398);
         if(!this.var_61.isListInited())
         {
            _loc2_ = this.const_815;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1537;
         }
         else
         {
            _loc2_ = this.const_1538;
         }
         if(this.var_2486 == _loc2_)
         {
            return;
         }
         this.var_2486 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_490.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_490.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_490.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_61.getGroupItemInIndex(_loc3_,this.var_398);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_741 && this.var_741.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1540)
         {
            _loc3_ = this.const_1540;
         }
         else if(_loc3_ < this.const_1539)
         {
            _loc3_ = this.const_1539;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_60)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_342);
            }
         }
      }
   }
