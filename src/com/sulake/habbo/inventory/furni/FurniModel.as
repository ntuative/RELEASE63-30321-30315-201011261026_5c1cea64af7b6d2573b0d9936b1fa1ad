package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1180:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_209,this.onObjectPlaced);
         this._catalog = param7;
         this.var_576 = new Timer(const_1180,1);
         ...
         this.var_2286 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_209,this.onObjectPlaced);
               }
            ...
            {
               this.var_181.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_181.stop();
               this.var_181 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_837 == null)
         {
            this.var_837 = this._windowManager.buildFromXML(this.var_2286) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_837.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_181 = new Timer(param1,1);
            this.var_181.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_181.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_318);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_460.add(const_42,new Array());
         this.var_460.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_280;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_328 || _loc3_.category == FurniCategory.const_313 || _loc3_.category == FurniCategory.const_374)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1305 && param1.type == RoomEngineObjectEvent.const_209)
         {
            this.var_1305 = false;
         }
      }
      ...
      {
         return this.var_460.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_280:
               ...
               break;
            case InventorySubCategory.const_938:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_460.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_460.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_703)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
