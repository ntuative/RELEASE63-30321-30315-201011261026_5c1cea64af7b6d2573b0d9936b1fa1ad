package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1157:int = 20;
      ...
      private var var_440:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_114 = param1;
         this.var_1517 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_50 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2071 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_817 + const_1157)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshListDims() : void
      {
         ...
         this.var_50.autoArrangeItems = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_50.numListItems)
         {
            _loc2_ = ITextWindow(this.var_50.getListItemAt(_loc1_));
      ...
      {
         param1.width = this.var_50.width;
         param1.height = param1.textHeight + const_1156;
         param1.invalidate();
      }
      
      private function refreshScrollBarVisibility() : Boolean
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_50.parent);
         var _loc2_:IWindow = _loc1_.getChildByName("scroller") as IWindow;
         var _loc3_:* = this.var_50.scrollableRegion.height > this.var_50.height;
         if(_loc2_.visible)
         {
            if(_loc3_)
            {
      ...
      private function findAddIndex() : int
      {
         ...
         while(_loc1_ < this.var_50.numListItems)
         {
            _loc2_ = this.var_50.getListItemAt(_loc1_);
            if(!_loc2_.visible)
            {
               return _loc1_;
            }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_440 == null || _loc1_.id != this.var_440.id)
         {
            this.var_440 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_440.followingAllowed)
         {
            this.var_1517.enable();
         }
         else
         {
            this.var_1517.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_50.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_440.messages.length - const_817);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_440.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_440.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc4_:ITextWindow = this.var_50.getListItemAt(param2) as ITextWindow;
         if(_loc4_ == null)
         {
            if(!param1)
            {
            ...
            _loc4_.width = this.var_50.width;
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_757 || param3.type == Message.const_769 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_440.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_114.send(new FollowFriendMessageComposer(this.var_440.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_769)
         {
            return 4292801535;
         }
         if(param1 == Message.const_873)
         {
            return 4294927974;
         }
