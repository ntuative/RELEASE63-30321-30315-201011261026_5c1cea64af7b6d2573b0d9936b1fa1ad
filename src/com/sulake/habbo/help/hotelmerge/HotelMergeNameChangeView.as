package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_680)
         {
            this.var_680 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_680)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_679)
         {
            this.var_679 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_679)
            {
               return;
            }
