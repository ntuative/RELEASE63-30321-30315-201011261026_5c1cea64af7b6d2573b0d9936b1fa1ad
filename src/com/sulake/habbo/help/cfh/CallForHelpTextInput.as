package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1214:int = 30;
      
      private static const const_1172:int = 253;
      
      private static const const_1173:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_161);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1214)
         {
