package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1638:uint = 11129827;
      ...
      private var var_1054:NameSuggestionListRenderer;
      ...
      private function showSelectionView() : void
      {
         if(!this.var_680)
         {
            this.var_680 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_680)
            {
               return;
            }
            this._window.content.addChild(this.var_680);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_679)
         {
            this.var_679 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_679)
            {
               return;
            }
            this._window.content.addChild(this.var_679);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_679.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_461;
         }
         this.showView(this.var_679);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_461);
      ...
      public function method_1(param1:int, param2:String, param3:Array) : void
      {
         var _loc8_:* = null;
         this.nameCheckWaitEnd(false);
         if(this.var_36 != this.var_680)
         {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_748:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_744:
            ...
            case ChangeUserNameResultMessageEvent.var_747:
               break;
            case ChangeUserNameResultMessageEvent.var_746:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_745:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_919 || param1 == ChangeUserNameResultMessageEvent.var_918)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1054 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1054.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_461 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_461);
               break;
