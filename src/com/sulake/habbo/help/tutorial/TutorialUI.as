package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_333:String = "TUI_NAME_VIEW";
      
      public static const const_315:String = "TUI_CLOTHES_VIEW";
      ...
      private var var_312:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         this.var_46 = param1;
         this.var_46.events.addEventListener(HabboHelpTutorialEvent.const_427,this.onTaskDoneEvent);
         this.var_46.events.addEventListener(HabboHelpTutorialEvent.const_455,this.onTaskDoneEvent);
         this.var_46.events.addEventListener(HabboHelpTutorialEvent.const_520,this.onTaskDoneEvent);
      }
      ...
      {
         return this.var_1290 && this.var_1032 && this.var_1289;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_46)
         {
            this.var_46.events.removeEventListener(HabboHelpTutorialEvent.const_427,this.onTaskDoneEvent);
            this.var_46.events.removeEventListener(HabboHelpTutorialEvent.const_455,this.onTaskDoneEvent);
            this.var_46.events.removeEventListener(HabboHelpTutorialEvent.const_520,this.onTaskDoneEvent);
            this.var_46 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_36 == null || this.var_36.id == const_88)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_455:
               if(this.var_36 != null && this.var_36.id == const_315)
               {
                  this.var_1608 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_1675 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_333:
               ...
               if(this.var_312 == null)
               {
                  this.var_312 = new NameChangeView(this);
               }
               this.var_312.showMainView();
               this.prepareForTutorial();
               break;
            case const_315:
         ...
         this._window.height = _loc2_.height + this.var_1676;
         this._window.width = _loc2_.width + this.var_1675;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_46.hideUI();
         this.var_46.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_107));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_36 != null && (this.var_36.id == const_333 || this.var_36.id == const_88))
         {
            this.showView(const_88);
         }
      }
      ...
      {
         this.var_1290 = true;
         if(this.var_36 != null && (this.var_36.id == const_315 || this.var_36.id == const_88))
         {
            this.showView(const_88);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_312.method_1(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_497)
         {
            this.var_312.checkedName = _loc2_.name;
         }
         else
         {
            this.var_312.method_1(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
