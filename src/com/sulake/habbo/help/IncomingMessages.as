   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            {
               this.var_2070 = _loc5_.id;
            }
            _loc4_++;
         }
         this._component.tellUI(HabboHelpViewEnum.const_719);
      }
      ...
      {
         this._component.showUI(HabboHelpViewEnum.const_343);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_161);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_450);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_301,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this._component.tellUI(HabboHelpViewEnum.const_246,_loc4_);
         }
      }
