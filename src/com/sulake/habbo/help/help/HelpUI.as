package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201011261021));
         this._toolbar = param5;
         this.var_94 = new Map();
         this.var_94.add(HabboHelpViewEnum.const_1329,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_161,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_450,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_301,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_246,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_567,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_343,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_674,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_239,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_94.add(HabboHelpViewEnum.const_891,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_94.add(HabboHelpViewEnum.const_936,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_719,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_466.length == 0 || param1 != this.var_315)
            {
               this.var_466.push(this.var_315);
            }
         }
         this.var_315 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_239:
               this.showUI(HabboHelpViewEnum.const_239);
               break;
            case CallForHelpResultEnum.const_934:
               this.showUI(HabboHelpViewEnum.const_936);
               break;
            case CallForHelpResultEnum.const_988:
               this.showUI(HabboHelpViewEnum.const_891);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_94.getValue(HabboHelpViewEnum.const_161) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_427));
      }
      ...
      {
         return this.var_94.getValue(this.var_315);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1675 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1676;
         this._window.width = _loc1_.width + this.var_1675;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_466.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_315 == HabboHelpViewEnum.const_161)
         {
            return;
         }
         if(this.var_587.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_587.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_587.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_316.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_587[1],this.var_587[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_587[0],this.var_587[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_315 == HabboHelpViewEnum.const_161 || this.var_466.length == 0)
         {
            return;
         }
         if(this.var_316 == null)
         {
            ...
            this.var_316 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_316.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_316.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_316 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_316 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_316 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
