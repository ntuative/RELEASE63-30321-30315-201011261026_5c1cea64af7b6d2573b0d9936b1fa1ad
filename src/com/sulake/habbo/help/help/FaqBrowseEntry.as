package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_202 = FaqItem(param1);
         }
         if(this.var_202 == null)
         {
            return;
         }
         if(!this.var_202.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_202.questionId));
            return;
         }
         var _loc3_:FaqCategory = this.var_202.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_202.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_202.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_202.index + 1);
         }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_202 != null)
         {
            _loc2_ = this.var_202.category;
            main.showUI(HabboHelpViewEnum.const_301);
            main.tellUI(HabboHelpViewEnum.const_301,_loc2_);
         }
      }
      ...
      private function onNextEntry(param1:WindowMouseEvent) : void
      {
         ...
         {
            main.tellUI(HabboHelpViewEnum.const_246,this.getNextItem());
         }
      }
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || this.var_202 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_202.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_202.index + 1);
      }
   }
}
