package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1500:String = "ctlg_";
       
      
      protected var var_1863:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1119:ICatalogViewer;
      ...
      private var var_1369:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1370:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1369 = new EventDispatcher();
      ...
      {
         return this._localization.method_8(this.var_1109);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1109);
      }
      ...
      {
         var _loc2_:String = const_1500 + param1;
         ...
         this.var_1863 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1863) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1370 = new ItemGridCatalogWidget(_loc1_);
            this.var_57.push(this.var_1370);
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1357) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1277) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new SingleViewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1375) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1461) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1314) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1369;
            _loc2_.init();
         }
         this.var_1369.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1369.dispatchEvent(param1);
      }
   }
}
