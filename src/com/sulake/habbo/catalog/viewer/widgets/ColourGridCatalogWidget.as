package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1672 = _loc1_.content as XML;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_685 = _loc2_.content as BitmapData;
         ...
         this.var_796 = _loc4_.content as BitmapData;
      ...
      private function populateColourGrid() : void
      {
         ...
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1672) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_978.width,this.var_978.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_796.width,this.var_796.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_796,this.var_796.rect,new Point(0,0),null,null,true);
