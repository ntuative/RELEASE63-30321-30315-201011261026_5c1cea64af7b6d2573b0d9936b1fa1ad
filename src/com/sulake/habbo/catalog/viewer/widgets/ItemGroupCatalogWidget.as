package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_561[this.var_1008][this.var_1576];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1008 = var_1148.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1008];
         var _loc3_:Array = this.var_561[this.var_1008] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1576 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1576] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_440 || _loc1_.pricingModel == Offer.const_514)
            {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_80 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_561.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_561[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
