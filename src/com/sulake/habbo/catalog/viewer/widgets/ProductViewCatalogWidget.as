package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1112:ITextWindow;
      ...
      private var var_1372:IScrollbarWindow;
      
      protected var var_1779:XML;
      
      private var var_2484:Array;
      ...
      {
         this.var_892 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1112 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1768 = new Point(this.var_82.x,this.var_82.y);
         this.var_487 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1372 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1769 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_892.text = _loc4_;
         this.var_1112.text = _loc5_;
         this.var_892.height = this.var_892.textHeight + 5;
         this.var_1112.y = this.var_892.y + this.var_892.height;
         this.var_1112.height = Math.max(130,this.var_1112.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_485:
                  _loc6_ = this.var_1769.clone();
                  if(this.var_487 != null)
                  {
                     this.var_487.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_487,this.var_1372,this.var_1779);
                     this.var_487.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_223:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_283,AvatarAction.const_445);
                              _loc16_.appendAction(AvatarAction.const_296,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2484)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2484 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            this.var_82.x = this.var_1768.x;
            this.var_82.y = this.var_1768.y;
            if(param3 != null)
            {
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_31,this.onPreviewImageReady);
      }
