package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1057.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1056 != null)
         {
            this.var_1056.removeEventListener(WindowKeyboardEvent.const_153,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1057 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1057 != null)
         {
            this.var_1057.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1056 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1056 != null)
         {
            this.var_1056.addEventListener(WindowKeyboardEvent.const_153,this.windowKeyEventProcessor);
         }
      }
