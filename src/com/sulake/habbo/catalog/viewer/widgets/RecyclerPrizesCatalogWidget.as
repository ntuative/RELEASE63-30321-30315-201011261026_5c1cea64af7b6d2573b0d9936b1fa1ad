package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1119:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1779:XML;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1119 = new PrizeViewer();
         this.var_714 = this.recycler.getPrizeTable();
         ...
         if(this.var_714.length > 0 && this.var_714[0].prizes.length > 0)
         {
            this.select(this.var_714[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_714.length)
         {
            this.createLevelItem(this.var_714[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1779) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1119.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
