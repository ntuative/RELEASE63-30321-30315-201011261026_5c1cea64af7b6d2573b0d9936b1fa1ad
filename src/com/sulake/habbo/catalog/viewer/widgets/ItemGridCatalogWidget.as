package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_332:IGridItem;
      
      private var var_1451:int = 0;
      
      private var var_179:Timer;
      
      protected var var_181:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_779,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_286,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_617,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         this.var_1148.destroyGridItems();
         this.var_1148 = null;
         this.var_1779 = null;
         this.var_332 = null;
         super.dispose();
      ...
      {
         this.var_1148 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_767 == page.offers.length)
            {
         ...
         while(_loc3_ < 3)
         {
            if(this.var_767 >= 0 && this.var_767 < page.offers.length)
            {
               _loc4_ = page.offers[this.var_767];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_485)
         {
            ++this.var_1451;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1451);
         }
      }
