package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_824:int = 0;
      ...
      {
         return this.var_559 != const_824;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1570 != RecyclerStatusMessageEvent.const_995;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_559 == const_384;
      }
      ...
      {
         this.var_559 = const_825;
         this.var_104 = new Array(const_170);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1570)
         {
            ...
            case RecyclerStatusMessageEvent.const_995:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1432:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_993:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1415:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_104.length < const_170)
         {
            return false;
         }
         var _loc1_:int = 0;
