package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1684:int = 1;
      
      public const const_1666:int = 2;
      
      public const const_1815:int = 3;
      ...
      private var var_2164:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_203)
         {
            this.var_203 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_203.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2166,this.var_2163,this.var_2165,this.var_2162);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1684,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_486)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2161 = _loc3_.creditsWaiting;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1666,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.furniCategoryId != this.var_2122 || param1.furniTypeId != this.var_2121)
         {
            return;
         }
      ...
      private function isPosterItem(param1:MarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1113)
               {
                  _loc2_ = true;
               }
            }
