package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_563 = 0;
         for each(_loc4_ in this.var_165)
         {
            if(_loc4_ > this.var_563)
            {
               this.var_563 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_563).toString().length - 1);
         this.var_563 = Math.ceil(this.var_563 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_563.toString();
         _loc3_.draw(_loc6_);
         this.var_1015 = param1 - _loc6_.textWidth - 2;
         this.var_819 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_819);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_819 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_1015 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1015,(param2 - this.var_819) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1015 + this.var_1015 / -this.var_2619 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_819 - this.var_819 / this.var_563 * this.var_165[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_165 && this._x.length > 1;
      }
   }
}
