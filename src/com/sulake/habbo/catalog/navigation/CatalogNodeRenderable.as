package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1195:Number = 4285716709;
      ...
      private var var_1671:Number = 4.294967295E9;
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_50);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_50);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1671 == 4294967295)
            {
               this.var_1671 = _loc1_.color;
            }
            _loc1_.color = const_1195;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1321;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_50);
            }
         }
         if(this.var_50 != null)
         {
            this.var_50.visible = true;
            this.var_50.height = this.var_50.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_50);
            }
         }
         if(this.var_50 != null)
         {
            this.var_50.height = 0;
      ...
      {
         this.var_50 = navigator.catalog.windowManager.buildFromXML(var_1327) as IItemListWindow;
         if(this.var_50 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1326) as IWindowContainer;
         }
         else
         {
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_31,this.onIconImageReady);
      }
