package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2607:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         this.var_291 = [];
         this.var_50 = this._container.findChildByName("navigationList") as IItemListWindow;
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in this._index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(this.var_50);
            }
         }
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_291.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_291)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_291.indexOf(_loc6_);
            this.var_291.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_291.indexOf(param1) == -1)
         {
      ...
      private function openNavigatorAtNode(param1:ICatalogNode) : void
      {
         ...
         for each(_loc2_ in this.var_291)
         {
            _loc2_.deActivate();
            _loc2_.close();
         }
      ...
      {
         this._catalog.openCatalogPage(this.var_2607,true);
      }
