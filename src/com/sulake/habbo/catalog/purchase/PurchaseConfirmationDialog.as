package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1793:int = 10;
      ...
      private const const_1515:uint = 4.293848814E9;
      
      private const const_1514:uint = 4.294967295E9;
      
      private const const_1792:uint = 4.291613146E9;
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_80.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_80.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_80 is Offer)
            {
               _loc10_ = this.var_80.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_80 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = this._catalog.getProductData(this.var_80.localizationId);
         ...
         var _loc8_:String = this.var_80.activityPointType == Purse.const_454 ? "pixels" : "activitypoints";
         switch(this.var_80.priceType)
         {
            case Offer.const_476:
               ...
               this._localization.registerParameter(_loc6_,"credits",this.var_80.priceInCredits.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_612:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits+activitypoints." + this.var_80.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,"credits",this.var_80.priceInCredits.toString());
               this._localization.registerParameter(_loc6_,_loc8_,this.var_80.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_80.activityPointType).toString());
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_601:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.activitypoints." + this.var_80.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,_loc8_,this.var_80.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_80.activityPointType).toString());
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_655 = _loc1_.boxTypes;
            this.var_654 = _loc1_.ribbonTypes;
            this.var_997 = this.var_1556[0];
            this.var_299 = this.var_655[0];
            this.var_301 = this.var_654[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_301 < 0)
         {
            this.var_301 = this.var_654.length - 1;
         }
         if(this.var_301 > this.var_654.length - 1)
         {
            this.var_301 = 0;
         }
         if(this.var_299 < 0)
         {
            this.var_299 = this.var_655.length - 1;
         }
         if(this.var_299 > this.var_655.length - 1)
         {
            this.var_299 = 0;
         }
         var _loc1_:int = this.var_655[this.var_299] * 1000 + this.var_654[this.var_301];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_80.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_997,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1253 = _loc3_.id;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_997);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_655[this.var_299]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_654[this.var_301]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_80,this.var_1254,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_80.offerId,this.var_1254);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_108:
               ...
               for each(_loc7_ in this.var_210)
               {
                  ...
                  if(_loc5_.length >= this.const_1793)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2119 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_744:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_300 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_300 + 1);
                     break;
      ...
      {
         if(this.var_224 == null || !this.var_224.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_224.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_300) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_224 == null)
         {
            this.var_224 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_553 == null)
         {
            this.var_553 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_553.procedure = this.suggestionsEventHandler;
         }
         if(this.var_224 == null || this.var_553 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_224.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_553.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_300) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_300);
         }
         this.var_300 = param1;
         if(this.var_300 < 0)
         {
            this.var_300 = _loc2_.numListItems - 1;
         }
         if(this.var_300 >= _loc2_.numListItems)
         {
            this.var_300 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_300) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1792;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1515) : uint(this.const_1514);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_224.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_997;
               }
            }
            _loc4_++;
         }
