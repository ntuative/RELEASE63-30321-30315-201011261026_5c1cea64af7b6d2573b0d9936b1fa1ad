package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1000:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_558 = new Timer(100);
         this.var_558.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_35 = new Array();
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,104,"a"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,94,"b"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,36,"c"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,84,"d"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"e"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"f"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,416,"i"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,320,"j"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,448,"k"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,352,"l"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,384,"m"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_51,372,"n"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,80,"g"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,74,"h"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,416,"o"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,352,"p"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,304,"q"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,336,"r"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,748,"u"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_61,438,"v"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_54,540,"t"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_54,512,"w"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_54,396,"x"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_54,440,"y"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_54,456,"z"));
         this.var_35.push(new RoomLayout(HabboClubLevelEnum.const_54,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_558)
         {
            this.var_558.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_558.reset();
            this.var_558 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1000.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1566 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1566 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_50 = IItemListWindow(this.var_153.findChildByName("item_list"));
         ...
         var _loc1_:IWindow = this.var_153.findChildByTag("close");
         _loc1_.procedure = this.onCancelButtonClick;
         this.var_999 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_153.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_153.desktop,this.var_153.width,this.var_153.height);
         this.var_153.x = _loc2_.x;
         this.var_153.y = _loc2_.y;
      }
      
      public function refresh() : void
      {
         this.var_999.goBackToInitialState();
         this.var_999.input.textBackgroundColor = 4294967295;
         this.var_1000 = this.var_35[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         while(this.var_50.numListItems > 0)
         {
            _loc6_ = this.var_50.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in this.var_35)
         {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < this.var_35.length)
         {
            _loc7_ = this.var_35[_loc4_];
            if(this.isAllowed(_loc7_))
            {
               if(_loc2_ == 0)
               {
                  _loc3_ = this.getRow();
                  this.var_50.addListItem(_loc3_);
               }
               this.addThumbnail(_loc3_,this.var_35[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               ...
               this.var_50.addListItem(_loc8_);
            }
         }
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         var _loc1_:Boolean = this.var_999.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_999.getText();
         var _loc4_:String = "model_" + this.var_1000.name;
