package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_375:IRoomSettingsCtrlOwner;
      ...
      {
         this.var_313 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_313));
         if(this.var_1037 != null)
         {
            this.var_1037.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_313)
         {
            return;
         }
         this.var_74 = param1;
         this._active = true;
         this.var_1620 = true;
         this.var_375.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_313)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_313 || this.var_1036 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1036 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1311)
         {
            this.var_676.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1265)
         {
            this.var_676.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1424)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1264)
         {
            ...
            this.setTagError(this.var_833,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1240)
         {
            ...
            this.setTagError(this.var_833,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1397)
         {
            this.var_832.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_651,this.onDoorModePasswordUnselect);
         ...
         this.var_833 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_832 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1039 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1040 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1042 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1043 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_572 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1618 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1293 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1038 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1041 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1617 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1294 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_231 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1037 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2252 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2251 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1619 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1619.procedure = this.onSwitchView;
         this.var_1037.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1618.visible = this._inRoom;
         this.var_1617.visible = this._inRoom;
         this.var_2251.visible = this.var_456;
         this.var_2252.visible = !this.var_456;
         if(this.var_456)
         {
            this.var_1041.visible = true;
            this.var_1294.visible = false;
         ...
         else
         {
            ...
            this.var_1294.visible = true;
            this.var_1293.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1293.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1038.height = Util.getLowestPoint(this.var_1038) + 4;
         }
         this.var_1619.text = !!this.var_456 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1618.name,this.var_1293.name,this.var_1038.name,this.var_1041.name,this.var_1294.name,this.var_1617.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_832.setText("");
         this.var_1039.setText("");
         ...
         {
            case RoomSettingsData.const_166:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_104);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_831,_loc1_.tags[0]);
         this.setTag(this.var_833,_loc1_.tags[1]);
         if(this.var_1040)
         {
            if(_loc1_.allowPets)
            {
               this.var_1040.select();
            }
            else
            {
               this.var_1040.unselect();
            }
         }
         if(this.var_1042)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_166;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_104;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_506;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_104)
         {
            _loc8_ = this.var_832.getText();
            _loc9_ = this.var_1039.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_832.clearErrors();
               this.var_1039.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1040.isSelected;
         _loc2_.allowFoodConsume = this.var_1042.isSelected;
         _loc2_.allowWalkThrough = this.var_1043.isSelected;
         _loc2_.hideWalls = this.var_572.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_831,_loc2_.tags);
         this.addTag(this.var_833,_loc2_.tags);
         this.clearErrors();
         this.var_1036 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_313);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_74.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_313]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_231.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_231.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_231.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_231.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_231.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_231.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_231.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_231);
         this.var_231.findChildByName("ruler").visible = true;
         ...
         if(this.var_74.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_231,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_313));
      }
