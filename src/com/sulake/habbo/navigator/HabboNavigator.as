package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_273:MainViewCtrl;
      
      private var var_573:RoomInfoViewCtrl;
      
      private var var_1044:RoomCreateViewCtrl;
      ...
      private var var_2658:Dictionary;
      
      private var _incomingMessages:IncomingMessages;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_2254:Array;
      
      private var var_2192:RoomThumbnailRenderer;
      
      private var var_832:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_273 = new MainViewCtrl(this);
         this.var_573 = new RoomInfoViewCtrl(this);
         this.var_1044 = new RoomCreateViewCtrl(this);
         this.var_2192 = new RoomThumbnailRenderer(this);
         this.var_832 = new GuestRoomPasswordInput(this);
         this.var_325 = new GuestRoomDoorbell(this);
         this.var_380 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_291,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_573.registerToolbarEvents();
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_158.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_273.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_273.startSearch(Tabs.const_217,Tabs.const_352,param1);
         this.var_273.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_273.startSearch(Tabs.const_273,Tabs.const_230);
         this.var_380.getTab(Tabs.const_273).tabPageDecorator.tabSelected();
      }
