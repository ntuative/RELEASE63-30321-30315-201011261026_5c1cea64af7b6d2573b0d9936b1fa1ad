package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1742:IWindowContainer;
      ...
      private var var_2453:IButtonWindow;
      
      private var var_1363:IButtonWindow;
      
      private var var_886:IDropMenuWindow;
      ...
      {
         this.var_886.visible = false;
         this.var_1742.visible = true;
         this.var_2452.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_705.setText(param1.eventDescription);
         this.var_831.setText(this.getTagFromEvent(param1,1));
         this.var_833.setText(this.getTagFromEvent(param1,2));
      ...
      private function createEvent() : void
      {
         ...
         this.var_705.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_831.goBackToInitialState();
         this.var_833.goBackToInitialState();
         this.var_886.selection = 0;
      ...
      {
         var _loc1_:int = this.var_886.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_705.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_831.getText());
         this.addTag(_loc6_,this.var_833.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_705.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1742 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2452 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1741 = ITextWindow(this.find("create_caption"));
            this.var_1743 = ITextWindow(this.find("edit_caption"));
            this.var_1361 = IButtonWindow(this.find("create_button"));
            this.var_1362 = IButtonWindow(this.find("edit_button"));
            this.var_2453 = IButtonWindow(this.find("cancel_button"));
            this.var_1363 = IButtonWindow(this.find("end_button"));
            this.var_886 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1361,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1362,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1363,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2453,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_705 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_831 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_833 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
