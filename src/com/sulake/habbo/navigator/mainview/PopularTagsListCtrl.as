package com.sulake.habbo.navigator.mainview
{
   ...
   public class PopularTagsListCtrl implements IViewCtrl
   {
      ...
      public function refresh() : void
      {
         ...
         var _loc2_:IWindowContainer = IWindowContainer(this.var_50.getListItemAt(0));
         if(_loc2_ == null)
         {
         ...
         while(_loc3_ < this._navigator.data.popularTags.tags.length)
         {
            ...
            this.var_1004.refreshTag(_loc2_,_loc3_,_loc4_.tagName);
            _loc3_++;
         }
         Util.layoutChildrenInArea(_loc2_,_loc2_.width,18,3);
         _loc2_.height = Util.getLowestPoint(_loc2_);
         this.var_153.findChildByName("no_tags_found").visible = _loc1_.length < 1;
      }
