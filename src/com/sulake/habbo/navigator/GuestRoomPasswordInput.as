package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomPasswordInput
   {
      ...
      private var var_943:GuestRoomData;
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:IButtonWindow = this._window.findChildByName("FurnitureDimmerWidgetHandler") as IButtonWindow;
         if(_loc2_ != null)
         {
      ...
      private function onTry(param1:WindowMouseEvent) : void
      {
         ...
         this._navigator.goToRoom(this.var_943.flatId,true,_loc3_);
         this.hide();
      }
