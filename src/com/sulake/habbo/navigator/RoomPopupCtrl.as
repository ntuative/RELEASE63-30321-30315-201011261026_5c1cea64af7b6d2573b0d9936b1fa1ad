package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2192 = new RoomThumbnailRenderer(param1);
         this.var_1004 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_156,this.var_105);
         if(this.var_105.ownerName != "" && this.var_105.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_156,!!this.var_105.event ? this.getEventCtg(this.var_105.categoryId) : this.getRoomCtg(this.var_105.categoryId));
         this.refreshRoomDesc(this.var_156,this.var_105);
         this.refreshExtraCont();
         this.refreshInfo(this.var_156,"trading_allowed",this.var_105.allowTrading);
         this.refreshInfo(this.var_156,"doormode_doorbell",this.var_105.doorMode == 1);
         this.refreshInfo(this.var_156,"doormode_password",this.var_105.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_156,this.var_105.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1004.refreshTags(_loc1_,this.var_105.tags);
         ...
         this.var_2192.refreshThumbnail(_loc1_,this.var_105.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_217,Tabs.const_203,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
