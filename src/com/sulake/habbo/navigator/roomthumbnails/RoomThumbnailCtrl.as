package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1520 = IButtonWindow(this.find("bg_tab"));
         this.var_1518 = IButtonWindow(this.find("top_tab"));
         this.var_1519 = IButtonWindow(this.find("obj_tab"));
         this.var_2074 = IWindowContainer(this.find("tile_grid"));
         this.var_2073 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1520,this.onBgTabButton);
         Util.setProcDirectly(this.var_1518,this.onTopTabButton);
         Util.setProcDirectly(this.var_1519,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_61.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_61.mode = ThumbnailEditorModel.const_57;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1520,this.var_61.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1518,this.var_61.mode != ThumbnailEditorModel.const_57);
         this.setEnabled(this.var_1519,this.var_61.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2073;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_61.mode == ThumbnailEditorModel.const_37);
         this.refreshEditImg(_loc1_,"edit_top",this.var_61.mode == ThumbnailEditorModel.const_57);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2074;
         _loc1_.visible = true;
      ...
      private function refreshImgSelectors() : void
      {
         ...
         this.refreshImgSelector(ThumbnailEditorModel.const_57);
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_62,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_291,HabboWindowStyle.const_39,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
