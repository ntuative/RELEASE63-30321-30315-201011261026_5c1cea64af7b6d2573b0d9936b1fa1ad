package com.sulake.habbo.session.handler
{
   ...
   public class RoomChatHandler extends BaseHandler
   {
      ...
      public function RoomChatHandler(param1:IConnection, param2:IRoomHandlerListener)
      {
         ...
         param1.addMessageEvent(new PetRespectNotificationEvent(this.method_6));
      ...
      private function method_6(param1:PetRespectNotificationEvent) : void
      {
      ...
      private function onFloodControl(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            ...
            listener.events.dispatchEvent(new RoomSessionChatEvent(RoomSessionChatEvent.const_435,_loc3_,-1,"" + _loc4_,0,null));
         }
      }
   }
}
