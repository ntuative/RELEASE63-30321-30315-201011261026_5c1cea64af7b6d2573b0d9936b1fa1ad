package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1279:String = "normal_badge";
       
      
      private const const_1536:String = "badge_";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = this.const_1536 + param1;
         ...
         switch(param2)
         {
            case const_1279:
               ...
               {
                  _loc5_ = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_987:
               if(this.var_158 != null)
               {
                  if(this.var_158 != null)
                  {
                     _loc5_ = this.var_158.getKey("group.badge.url");
         ...
         if(_loc4_ != null)
         {
            ...
            _loc8_.addEventListener(AssetLoaderEvent.const_31,this.onBadgeImageReady);
         }
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_1536,"");
