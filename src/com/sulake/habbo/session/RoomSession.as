package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1798:int = 2500;
      ...
      private var var_1068:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1068 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1068.connection = param1;
         }
      }
      ...
      public function start() : Boolean
      {
         ...
         {
            this._state = RoomSessionEvent.const_82;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1319));
         this.var_1318.add(this.var_1319,getTimer());
         ++this.var_1319;
      }
      
      public function receivedChatWithTrackingId(param1:int) : void
      {
         var _loc2_:Object = this.var_1318.remove(param1);
         if(_loc2_ != null)
         {
            if(getTimer() - int(_loc2_) > this.const_1798)
            {
      ...
      {
         return this.var_1068 as IUserDataManager;
      }
