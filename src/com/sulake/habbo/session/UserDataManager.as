package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      {
         return this.getUserDataByType(param1,const_1178);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_830.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_830.remove(param1);
         this.var_830.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1177);
      }
